...
\centerline{\includegraphics[width=0.7\linewidth,draft=true]{figures/cosmoglobe.png}}
\end{minipage}
...
\commanderfour\ is the latest generation of the \Commander\ framework, which, once again, means a major rewrite of the \Commander\ code, in order to be able to efficiently paralelize the code and to be able to run on modern high performance computing architectures, in order to be able to handle larger, new generation datasets. \commanderfour\ is currently being developed in Python and is publicaly available on GitHub\footnote{\url{https://github.com/Cosmoglobe/Commander4}}. It is designed to be more modular and flexible than its predecessors, specifically to allow new contributors to easily analyse their own datasets using it or even add new features.
