...
%DIF ADD main.tex        Thu Jan 29 14:19:20 2026
...
Conversely, at very long and very short wavelengths, a more aggressive Galactic mask is required. These are shown in green in Fig.~\ref{fig:masks}, and are defined again by regions in which the foregrounds are bright and not modeled sufficiently well. {The specific values for masks are chosen based on smoothed residual masks from preliminary runs, with brightnesses determined by the overall signal-to-noise level within each band.}

\section{Ancillary data sets}
\label{sec:ancillary}
\begin{figure*}
  \centering
  \includegraphics[width=0.235\linewidth]{figs/solarmap_01a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_01b_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_06a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_06b_v4.pdf}\\
  \includegraphics[width=0.235\linewidth]{figs/solarmap_02a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_02b_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_07a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_07b_v4.pdf}\\
  \includegraphics[width=0.235\linewidth]{figs/solarmap_03a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_03b_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_08a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_08b_v4.pdf}\\
  \includegraphics[width=0.235\linewidth]{figs/solarmap_04a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_04b_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_09a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_09b_v4.pdf}\\
  \includegraphics[width=0.235\linewidth]{figs/solarmap_05a_v4.pdf}\hspace*{2mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_05b_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.235\linewidth]{figs/solarmap_10a_v4.pdf}\hspace*{2mm}
...
As demonstrated by the success of the \bp\ and \cosmoglobe\ projects, the use of complementary datasets with different angular resolution, frequency coverage, and observation strategies, can greatly improve the quality of low-level data processing. In this work, we use \Planck\ High Frequency Instrument, \WISE, \GAIA, and \COBE-FIRAS to better constrain our sky model and characterize the DIRBE data. \section{Excess radiation model}
\label{sec:excess}
...
The \Planck\ High Frequency Instrument (HFI; \citealt{planck2016-l03}) observed the sky in six channels from 100\,GHz to 857\,GHz from May 2009--2013, with angular resolution of 10\arcm--\,4\arcm.While the primary purpose of the \Planck\ mission was to characterize fluctuations in
the CMB, a large part of its scientific legacy comes from its observations of the far-infrared sky, with robust characterization of the Milky Way \citep{planck2013-XVII,planck2014-a12,planck2016-l03} and of CIB fluctuations \citep{planck2014-a12,planck2013-XVII,lenz2019,mccarthy:2024}One of the key novel features of the current analysis is the inclusion
...
In addition to its complementary observation strategy, \Planck's frequency coverage has a relatively lower expected amount of zodiacal emission, with a total expected amplitude of $\lesssim1\,\%$ before any
subtraction \citep{maris2006c,planck2013-pip88}, as compared to almost 100\,\% of the signal in some DIRBE bands. All delivered \Planck\ maps have had an estimate of As described in Sect.~\ref{sec:global_modelling}, we model any
...
zodiacal emission modeled using the 3D model derived by Earth-trailing feature \citep{kelsall1998}. These two physical
...
corresponding parameters at the respective K98 with varying emissivities per component . While this technically is redundant information that could contaminate this joint analysis,
...
At the same time, CIB fluctuations with a similar SED to the Milky Way have been detected with high significance in the
...
CIB from the HFI maps before including them in our analysis. \subsection{Characterization}

Since this work is
primarily concerned with the DIRBE dataset, the modeling of
CMB temperature fluctuations gives an unnecessary degree of freedom to be marginalized over. Therefore, we subtract the \commanderthree\ PR3 CMB temperature estimate from the \Planck\ HFI maps, effectively conditioning the entire Gibbs chain on this CMB estimate.We use single \Planck\ detector maps to avoid the complication of subtle bandpass mismatches between nearby detectors. In total, we use the 100-1, 217-1, and 353-1 temperature maps and the total 545\,GHz and 857\,GHz maps, all from the PR4 release \citep{npipe}. In order to characterize the spatial morphology of
...
posterior mean maps for {each half-mission and channel}. Blue pixels correspond to
directions on the sky that are never observed by the DIRBE instrument {within the relevant period},
...
In the near-infrared, most of the sky observed by DIRBE consists of stars and point sources. We therefore use catalogs derived from external datasets as fixed locations of each source,
while fitting for the amplitudes in the Gibbs chain. As of this publication, the most complete catalog of stars in the Milky Way comes from the \Gaia\ mission \citep{gaia:2016,gaia:2018}. In particular, physics models of 100\,million stars are provided in \Gaia\ DR2.
Despite \Gaia\ operating between 330--1050\,nm, these models can be used as informative priors for the amplitude of stars at the DIRBE near-infrared bands. With a limiting magnitude of $G\sim20$ across the entire sky, this star catalog gives a
complete survey of all stars that are detectable within the DIRBE bandsBrowsing through the various panels, we can immediately make several
interesting observations. First, {on the positive side}, we see
that {the 240$\,\mu$m channel appears} for all practical
...
Conversely, the \WISE\ satellite \citep{wright:2010} has mapped the sky at 3.4, 4.6, {However, the same does not hold true in general, as there are
  ...
  22 $\mathrm{\mu m}$, with resolutions of 6\farcs11, 6\farcs4, 6\farcs5, and 12\farcs0. This gives a direct estimate of point source brightness and
  location,
  and
  allows for direct cross-matching with the \GAIA\ DR2 catalog. In order to
  leverage the \gaia\ data properly, we extract the SED for point sources in both \gaia\ and \WISE\ with $<8$ mag at $3.4\,\mathrm{\mu m}$. These SEDs are then scaled directly per star in the Gibbs chain to correct for absolute calibration differences between the \gaia+\WISE\ catalog and DIRBE. There are a total of 71725\,454 stars in both catalogs. There are an additional 66$\mu$m channels, are very likely due to mismodelling of the ZL
  cloud component. However, the origin of the asymmetric features, as for
  instance seen in the 4.9\,217 extragalactic sources that exist in \WISE\ but not in \gaia.
  These are fit as modified blackbodies per source.
$\mu$m channel, are not easily explained
  in terms of ZL mismatch; further study is needed to understand the
  origin of these.
  }

Within the Galactic plane, there are many stars per single DIRBE pixel. In order to avoid degeneracies between individual point sources, we create a map at $N_\mathrm{side}=512$ that includes all \WISE\ point sources that are $>8$ mag at $3.4\,\mathrm{\mu m}$ but have not been identified within the \gaia\ catalog. The SED's
  as derived by \gaia\ are then averaged over and used to scale the entire template . Within the Gibbs chain, this is sampled with a total scaling parameter, with a fixed map and relative amplitudes between different frequencies.For afull description of the star model, see the work in companion paper \citet{CG02_04}.{When interpreting these maps physically, it is important to
...
\subsection{\COBE-FIRASMitigation through masking and subtraction}

As far as the current analysis is concerned, determining the true
physical origin of the excess {signals seen in
...
$240\,\mathrm{\mu m}$ bands has already been noted to reduce the discrepancy between the two experiments. The possibility of joint determination of gain and
zodiacal emission using both of these datasets will be explored in future work. only apply the above masking procedure. 
...
Due to the observation strategy, there are non-negligible correlations between nearby frequencies, and smearing along the scanning direction, corresponding to an effectively nonsymmetric beam. In order to take the beam into account, we explicitly smooth the sky model following the same prescription as in
...
With the model in hand, we run \commanderthree\ on the data. We find that an average Gibbs iteration takes approximatly 500approximately 250\,CPU-hrs, excluding initialization time. In order to ensure proper sampling of the full distribution, we run six {five} independent \commanderthree\ runs initialized with their own random seeds. Each chain has 155, 157, 158, 160, 163, and 160 \textbf{The chains have 244, 246, 246, 242, and 246} samples, giving a total of 953 \textbf{1224} samples. A total of one month walltime on 416 1920 computing cores was required to produce these samples.

In order to assess burnin burn-in and convergence, we plot a range of parameters from the Gibbs chain in Fig.~\ref{fig:trace}. Included in this figure are the sampled monopoles, zodiacal dust albedos and emissivities, and instrumental parameters, including the estimated white noise in bands 1 and 10, and the correlated noise parameters $f_\mathrm{knee}$ and $\alpha$ for band 10. From this figure, some burnin burn-in can be seen in the monopoles, concluding at approximately sample 20.  At the same time, there is still drift within the emissivity and albedos, especially for parameters less strongly expressed in the model, such as $A_{4,\mathrm C}$ and $E_{9/10,\mathrm C}$. . However, since the monopoles are stable beyond this point, this is mainly due to degeneracies within the zodiacal model itself. This is explored in full detail in \citet{CG02_02}.

Discarding the burnin of 20 samples, we obtain a total of 833 independent Gibbs samples . In our analysis, we truncate all chains to be the length of the shortest chain, giving {Depending on the parameter of interest, 30--50 samples are considered burned in. This gives us a total of 810 samples. 974--1074 total samples, depending on the parameter.}
 Due to the extended burn-in of the zodiacal parameters, individual ZL parameters cannot be considered as fully converged. However, this does not affect the monopoles and frequency maps, which only depend on the sum of all ZL components, which are the main topic in this paper.
...
The two {three} instrumental noise parameters are chosen as representative of the behavior of instrumental noise parameters in general. The white noise level is correlated with the monopoles and local dust temperature $T_0$, demonstrating \textbf{albedos, which are themselves weakly correlated with the monopoles. This demonstrates} the dependence of some instrumental parameters on the final noise level. Conversely, band 10's noise parameters, while degenerate with each other as expected (see \citealt{bp04} and \citealt{bp06}), have negligible correlation with zodiacal dust and monopole parameters\textbf{correlations with the monopoles}.
...
in the form of posterior mean and rms root-mean square (RMS) estimates for each sampled
quantity, and we start with noise estimation and overall
goodness-of-fit goodness of fit statistics. The algorithms used in the current
...
\begin{figure}
	...
	\caption{Instrumental noise $\sigma_0$ for each band, averaged over all Gibbs chains. Data not used in the Gibbs chain chains are not displayed. Bands $12$--$240\,\mathrm{\mu m}$ are plotted in units of $\mathrm{MJy\,sr^{-1}}$, while all others are in $\mathrm{kJy\,sr^{-1}}$.}
	\label{fig:sigma0}
\end{figure}
...
\begin{figure}
	...
	\caption{Realization of correlated noise for first half-mission of $240\,\mathrm{\mu m}$ band, from the 25th {250th} sample of the first chain.}
  \label{fig:ncorr_map}
\end{figure}
...
\begin{figure*}
  ...
  \includegraphics[width=0.37\linewidth]{figs/rms_maps/rms_02.pdf}\includegraphics[width=0.35\linewidth]{figs/rms_maps/rms_01.pdf}       
  ...
  \includegraphics[width=0.37\linewidth]{figs/rms_maps/rms_04.pdf}\includegraphics[width=0.35\linewidth]{figs/rms_maps/rms_03.pdf}
  ...
  \includegraphics[width=0.37\linewidth]{figs/rms_maps/rms_06.pdf}\includegraphics[width=0.35\linewidth]{figs/rms_maps/rms_05.pdf}       
  ...
  \includegraphics[width=0.37\linewidth]{figs/rms_maps/rms_08.pdf}\includegraphics[width=0.35\linewidth]{figs/rms_maps/rms_07.pdf}
  ...
  \includegraphics[width=0.35\linewidth]{figs/rms_maps/rms_10.pdf}       
	\caption{White noise rms RMS maps for each DIRBE channel. All maps are in units of $\mathrm{MJy\,sr^{-1}}$.}
...
\end{figure*}
       ...
       \begin{figure*}
       	...
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_02_todres_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/todres_01.pdf}       
       	\includegraphics[width=0.35\linewidth]{figs/todres_02.pdf}\\
        \includegraphics[width=0.35\linewidth]{figs/dirbe_03_todres_v4.pdf}
        \includegraphics[width=0.35\linewidth]{figs/dirbe_04_todres_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/todres_03.pdf}
        \includegraphics[width=0.35\linewidth]{figs/todres_04.pdf}\\         
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_05_todres_v4.pdf}       
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_06_todres_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/todres_05.pdf}       
       	\includegraphics[width=0.35\linewidth]{figs/todres_06.pdf}\\       
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_07_todres_v4.pdf}
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_08_todres_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/todres_07.pdf}
	       ...
	       \caption{Data-minus-model residual maps for each band for one arbitrarily chosen {averaged over all Gibbs samplesamples}. The 140 and 240\,$\mu$m channels have been smoothed to an angular resolution of $3^{\circ}$, while all others are shown at their native resolution. }
       	\label{fig:res}
       \end{figure*}
       ...
       \begin{figure*}
       	...
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_02_hmhd_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/hmhd_01.pdf}       
       	\includegraphics[width=0.35\linewidth]{figs/hmhd_02.pdf}\\
        \includegraphics[width=0.35\linewidth]{figs/dirbe_03_hmhd_v4.pdf}
        \includegraphics[width=0.35\linewidth]{figs/dirbe_04_hmhd_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/hmhd_03.pdf}
        \includegraphics[width=0.35\linewidth]{figs/hmhd_04.pdf}\\         
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_05_hmhd_v4.pdf}       
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_06_hmhd_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/hmhd_05.pdf}       
       	\includegraphics[width=0.35\linewidth]{figs/hmhd_06.pdf}\\       
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_07_hmhd_v4.pdf}
       	\includegraphics[width=0.35\linewidth]{figs/dirbe_08_hmhd_v4.pdf}\includegraphics[width=0.35\linewidth]{figs/hmhd_07.pdf}
	       ...
	       \caption{Zodi-subtracted half-mission half-difference maps for each channel for one arbitarily chosen {averaged over} all Gibbs samplesamples. The 140 and 240\,$\mu$m channels have been smoothed to an angular resolution of $3^{\circ}$, while all others are shown at their native resolution. }
       	\label{fig:hmhd}
       \end{figure*}
	 ...
	 \label{fig:hmhd_powspec}
       ...
       \begin{figure}
       	...
       	\includegraphics[width=\linewidth]{figs/chisq_Cosmoglobe_DR2_c1_samp301_v4.pdf}
       	\caption{Pixel-space reduced normalized $\chi^2$ in units of $\sigma$. The number of degrees-of-freedom per pixel is here assumed to be 10320, which is equal to the sum of the number of observations per $N_{\mathrm{side}}=512$ pixel minus the number of freely fitted Galactic componentsDIRBE bands. }
       	\label{fig:chisq}
       \end{figure}
...
for all channels except 140 and 240$\,\mu$m this simply consist consists of a white
noise rms RMS per TOD sample, $\sigma_0$, which is assumed to be constant
...
\Planck\ LFI. 
We have not yet been able to locate
similar publicly available house-keeping information for DIRBE.{A preliminary analysis of available housekeeping data (J.~Weiland, priv.~comm) does not
...
has an a rotation period relative to the Earth of about 4~weeks.
...
channels are is their much higher overall noise level, which is almost
...
noise PSD power spectral density as well as noise realizations to be fit and removed in the
...
a ``trash can'' for unmodelled effects, the abscence absence of large coherent
features provides strong evidence that the adopted signal model is
indeed able to account for all main effects. 

It is also important to note that we sampled the time-variable gain for the 12 and 25$\,\mu$m
...
rms RMS as a function of position on the sky after accounting for including the
...
defined in Sect.~\ref{sec:excess}, which removes remove a significant
fraction of the overall data, and affects affect some parts of the sky more
...
wavelength band, and these are shown in Fig.~\ref{fig:res}. With perfect modeling of the sky, this should only consist of instrumental noise. Starting
...
under-subtracted. In this {The relatively larger degree of oversubtraction at 1.25$\,\mathrm{\mu m}$ is due the emissivity, which is applied uniformly for all stars. In practice, this overestimates the effect of extinction in the highest density portions of the Galactic plane.} In this respect it is important to note that the
...
WISE {AllWISE} catalog is, however, much higher at high Galactic latitudes than
...
{These bands also have residuals northwest of the Galactic plane, corresponding to the relatively low depth of coverage in the AllWISE coverage.}

In general, only very faint ZL residuals are seen in the two
shortest wavelength bands, {with the exception of the ecliptic plane at $1.25\,\mathrm{\mu m}$}. In order to suppress these further, it is
worth considering fitting the albedo of the asteroidal bands
independently from the cloudthat of the diffuse cloud component; however, the signal-to-noise ratio S/N  of
...
there are therefore massive opportunities {Recall that each of the dust components are fit to a template, with a global amplitude per frequency channel. It is therefore expected that more high-resolution data in the infrared, such as from \AKARI, \IRAS, and SPHEREx, will allow
}
for refining the current
model without compromising the overall signal-to-noise ratio S/N and
...
component into more local clouds \citep{CG02_05}\citep{CG02_05,CG02_06,CG02_07}.
...
noise level, which indicates that the current residuals unmodeled features are about one
order of magnitude larger than white noise in pixel space. 
{It is likely that these are primarily due to unmodeled sky components, including zodiacal dust and Galactic emission.}
Above
$\ell\gtrsim100$ this discrepancy falls smoothly to about unity due to
the DIRBE beam. Indeed, {Indeed, except for the 1.25 to 3.5 and 14 to 240$\,\mu$m
  and 2.2\,$\mu$m
...
an exact definition, see \citet{bp10}. {The number of degrees
  of freedom per pixel is here assumed to be 103, which 20, which simply equals
  the total number of individual frequency map pixelsper $N_{\mathrm{side}}=512$
...
diffuse components; in the current
  ...
  residuals, as discussed above. However, there are also large
some extended
  regions for which the goodness of fit is within the expected range
  of $\pm2\sigma$. This , which is a strong testament to the overall quality
...
\begin{figure*}
  ...
  \caption{Posterior rms RMS maps for each DIRBE channel. These account
...
\begin{figure*}
	...
	\caption{Comparison of \Cosmoglobe\ DR2 (\emph{left column}) and K98 (\emph{middle column}) zodiacal light subtracted mission average maps for the 1.25 to 124.9$\,\mu$m channels. Difference maps are shown in the rightmost column. Full maps are plotted with a non-linear color scale, while difference maps are plotted with a linear and symmetric color range.}
...
\begin{figure*}
	...
	\caption{Same as Fig.~\ref{fig:freqmaps_cg_vs_dirbe1}, but for the 25--24012--240$\,\mu$m channels.}
...
monopole and clear ZL band residuals. A minor exception is also Other minor exceptionis include the
12 and 60$\,\mu$m channels, which also shows {show} slight evidence of residual ZL
...
\begin{figure}
	...
	\includegraphics[width=\columnwidth]{figs/cls_DR2_vs_DIRBE_v4.pdf}
	\caption{Comparison of angular power spectra computed from the DIRBE (red) and DR2 (blue) ZSMA maps.}
	\label{fig:powspec}
\end{figure}

Figure \ref{fig:rms} shows the posterior rms RMS maps for each channel. It
...
that {the $1.25\,\mathrm{\mu m}$ DR2 channel has a brighter Ecliptic plane
than K98, and in bands $2.2$ and $3.5\,\mathrm{\mu m}$,} K98 has a brighter Ecliptic plane than DR2, but it is still .
It is very
...
visual ambiguity: Here we clearly see that the Herethe K98 map exhibits
ZL residual clear residuals while the DR2 model is visually clean. The
...
{The largest discrepancies are the higher noise levels in channels 5 and 6. This is due to the more aggressive masking based on the Solar-centered masking, as indicated in Table~\ref{tab:data_selection}.}
...
In this work, we have presented a joint analysis of DIRBE CIOs TOD in a global Bayesian framework using external \Planck, \Gaia, WISE, and FIRAS data. In combination with an improved zodiacal dust model \citep{CG02_02}, an improved thermal dust model \citep{CG02_05}\citep{CG02_05,CG02_06,CG02_07}, and an infrared stellar model \citep{CG02_04}, we have produced maps using DIRBE data with unprecedented zodiacal dust removal and absolute monopole determination. As shown in \citet{CG02_03}, these have led to improved CIB monopole constraints across all existing DIRBE bands.
...
\begin{acknowledgements}
  ...
  Goldsmith, Shuji Matsuura, Sven Wedemeyer, and Janet Weiland Janet Weiland and {Edward Wright} for
