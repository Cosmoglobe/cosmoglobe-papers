...
In this work, we have presented a joint analysis of DIRBE CIOs in a global Bayesian framework using external \Planck, \Gaia, WISE, and FIRAS data. In combination with an improved zodiacal dust model \citep{CG02_03}, an improved thermal dust model \citep{CG02_04}, and an infrared stellar model \citep{CG02_05}, we have produced maps using DIRBE data with unprecedented zodiacal dust removal and absolute monopole determination. As shown in \citet{CG02_02}, these have led to improved CIB monopole constraints across all existing DIRBE bands.
