...
At the same time, these channels are where the instrumental noise is best
understood, allowing for a correlated noise PSD as well as noise realizations
to be fit and removed in the $240\,\mathrm{\mu m}$ band. One realization of this
is shown for the first half-mission split in Fig.~\ref{fig:ncorr_map}.
...
%\textcolor{red}{TODO: Update this text to describe the new mask procedure}
...
which is due to the correlated noise component, a single realization of which is shown in Fig~\ref{fig:ncorr_map}. The overall amplitudes
