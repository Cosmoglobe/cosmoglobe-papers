...
\subsection{Global posterior analysis}

\subsection{Gibbs sampling and \commanderthree}

\subsection{DIRBE-specific Gibbs steps}
...
\clearpage
\section{Survey of main astrophysical results}
