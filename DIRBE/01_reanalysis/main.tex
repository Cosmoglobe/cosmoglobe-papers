...
\textbf{Gain! We are fitting it in bands 5 and 6! A cool plot incoming.}
...
for full details, see \citet{CG02_05,CG02_06}. The \textbf{four} components correspond
...
bands are not used for the actual fit. \textbf{These individually fit sources are are denoted as ``bright
...
independently from the cloud; however, the S/N  of
