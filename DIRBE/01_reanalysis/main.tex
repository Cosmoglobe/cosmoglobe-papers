...
The sixth component corresponds to \textbf{bright} starlight emission, which
...
%\textbf{All of these data are not used in the full end-to-end processing. Instead they are used during preliminary runs only performed in map space, and  are used to determine dust morphology (Sec.~\ref{sec:planckhfi}), gain (Sec.~\ref{sec:firas}), and point source contributions (Sec.~\ref{sec:gaia_and_wise}).
%}
