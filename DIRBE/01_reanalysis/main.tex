...
\def\WMAP{\ensuremath{\textit{WMAP}}}
\def\COBE{\ensuremath{\textit{COBE}}}
\def\GAIA{\ensuremath{\textit{Gaia}}}
\def\gaia{\ensuremath{\textit{Gaia}}}
\def\Gaia{\ensuremath{\textit{Gaia}}}
\def\WISE{\ensuremath{\textrm{WISE}}}
...
The dense frequency spacing of the FIRAS data makes it ideal for determining the continuum behavior of sky emission and allows for identification of emission lines \citep{bennett:1992}.
...
\begin{figure}
  ...
  \vspace{-1cm}
	...
	\caption{Correlated noise sample for the 240$\,\mu$m channel.}
	\label{fig:ncorr}
\end{figure}
...
\subsection{Goodness-of-fit}
       ...
       \begin{figure*}
        ...
        \includegraphics[width=0.39\linewidth]{figs/res_maps/res_03a_c0001_000022.pdf}\\
       	...
       	\caption{Data-minus-model residual maps for each band. The color scales are $\pm 0.05$ (MJy/sr) for bands 1-5, $\pm 0.5$ for bands 5-7, and $\pm 2.5$ for bands 8-10.}
       	\label{fig:res}
       \end{figure*}
       ...
       \begin{figure*}
        ...
        \includegraphics[width=0.39\linewidth]{figs/res_maps/res_03a_c0001_000022.pdf}\\
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_02a_c0001_000022.pdf}
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_01a_c0001_000022.pdf}       
       	\caption{Half-mission difference maps for each channel.}
       	\label{fig:hmhd}
       \end{figure*}
	 ...
	 \caption{Half-mission half-difference angular power spectra for each DIRBE channel. The dashed lines show the power spectrum computed from one white noise realization.}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{figs/cls_lowl_BP8_v5.pdf}
	\caption{Comparison of angular power spectra computed from the DIRBE and DR2 ZSMA maps.}
	\label{fig:powspec}
\end{figure}
