...
\begin{figure}
	...
	\caption{Instrumental noise $\sigma_0$ for each band, averaged over all Gibbs chains. Data not used in the Gibbs chain are not displayed. {\bf (Needs to be updated!)}}
	\label{fig:sigma0}
\end{figure}
...
\begin{figure*}
  ...
  \includegraphics[width=0.39\linewidth]{figs/rms_maps/rms_01.pdf}       
	\caption{White noise rms maps for each DIRBE channel. All maps are in units of $\mathrm{MJy\,sr^{-1}}$. {\bf (Needs to be updated!)}}
...
\begin{figure}
  % script to make these are in /mn/stornext/u3/metins/dirbe/DR2/plot_maps.py (cosmoglobe_analysis_plotter.plot_ncorr_maps(sample=19))
	...
	\caption{Correlated noise sample for the first half-mission of the 240$\,\mu$m channel. {\bf (Needs to be updated!)}}
	\label{fig:ncorr}
\end{figure}
...
\begin{figure}
	...
	\caption{Correlated noise angular power spectrum for the 240$\,\mu$m channel. {\bf (Needs to be updated!)}}
...
\subsection{Goodness-of-fit}
       ...
       \begin{figure*}
       	\centering
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_10a_c0001_000022.pdf}       
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_09a_c0001_000022.pdf}\\
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_08a_c0001_000022.pdf}       
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_07a_c0001_000022.pdf}\\
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_06a_c0001_000022.pdf}       
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_05a_c0001_000022.pdf}\\       
        \includegraphics[width=0.39\linewidth]{figs/res_maps/res_04a_c0001_000022.pdf}         
        \includegraphics[width=0.39\linewidth]{figs/res_maps/res_03a_c0001_000022.pdf}\\
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_02a_c0001_000022.pdf}
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_01a_c0001_000022.pdf}       
       	\caption{Data-minus-model residual maps for each band. The color scales are $\pm 0.05$ (MJy/sr) for bands 1-5, $\pm 0.5$ for bands 5-7, and $\pm 2.5$ for bands 8-10. {\bf (Needs to be updated!)}}
       	\label{fig:res}
       \end{figure*}
       ...
       \begin{figure*}
        ...
        \includegraphics[width=0.39\linewidth]{figs/res_maps/res_03a_c0001_000022.pdf}\\
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_02a_c0001_000022.pdf}
       	\includegraphics[width=0.39\linewidth]{figs/res_maps/res_01a_c0001_000022.pdf}       
       	\caption{Half-mission difference maps for each channel. {\bf (Needs to be updated!)}}
       	\label{fig:hmhd}
       \end{figure*}
       ...
       \begin{figure}
       	...
       	\caption{Pixel-space reduced normalized $\chi^2$. {\bf (Needs to be updated!)}}
       	\label{fig:chisq}
       \end{figure}

       \begin{figure}
	 \centering
	 \includegraphics[width=\columnwidth]{figs/cls_lowl_BP8_v5.pdf}
	 \caption{Half-mission half-difference angular power spectra for each DIRBE channel. The dashed lines show the power spectrum computed from one white noise realization. {\bf (Needs to be updated!)}}
...
\begin{figure*}
	...
	\caption{{\bf (Needs to be updated!)}}
...
\begin{figure*}
  ...
  \includegraphics[width=0.39\linewidth]{figs/res_maps/res_02a_c0001_000022.pdf}
  \includegraphics[width=0.39\linewidth]{figs/res_maps/res_01a_c0001_000022.pdf}       
  \caption{Posterior rms maps for each DIRBE channel. {\bf (Needs to be updated!)}}
  \label{fig:rms}
\end{figure*}
...
\clearpage
\section{Comparison with official DIRBE products}

\subsection{ZSMA maps}
...
\begin{figure*}
	...
	\caption{Same as Fig.~\ref{fig:freqmaps_cg_vs_dirbe1}, but for the 25--240$\,\mu$m channels. {\bf (Needs to be updated!)}}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{figs/cls_lowl_BP8_v5.pdf}
	\caption{Comparison of angular power spectra computed from the DIRBE and DR2 ZSMA maps.  {\bf (Needs to be updated!)}}
	\label{fig:powspec}
\end{figure}
