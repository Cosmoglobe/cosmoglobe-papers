...
While Fig.~\ref{fig:sigma_0} shows the white noise level in
...
near-planet observations. The 2.2 and 3.5$\,\mu$ channels shows very
similar behaviour.
...
the Milky Way, which is about 100\,billions. The completeness of the
...
gray lines in Fig.~\ref{fig:solarmps}. These were generated by
...
The individual DR2 ZSMA maps are shown in Figs.~\ref{fig:freqmaps1_2}--\ref{fig:freqmaps9_10}
