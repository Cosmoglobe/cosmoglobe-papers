...
Eqs.~\eqref{eq:model} and \eqref{eq:skymodel}, and noting that the set
...
implementation is \commander \citep{eriksen2004}, which was used
...
posteriors. However, most of these steps require slight modifications
in order to work efficiently for DIRBE, and we discuss these
optimizations below. In contrast, the two last steps which correspond
to zodiacal light sampling have been unsupported until the current
work, and the full implementation of these steps is described in a
companion paper by \citet{CG02_2}. 
