...
\begin{figure*}
  ...
  \caption{Posterior rms maps for each DIRBE channel. These account
    ...
    white noise. All maps are in units of $\mathrm{kJy\,sr^{-1}}$.}
  \label{fig:rms}
\end{figure*}
