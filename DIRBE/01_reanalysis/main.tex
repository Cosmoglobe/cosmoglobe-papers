...
due to the other model components in Eq.~\eqref{ref:model}. To obtain
...
\citet{bp10,bp11,bp12,bp13,watts2023_dr1}.
...
maps with the corresponding DIRBE K98 products. The right column shows
...
additional effective filtering from the the coarses QUADCube
...
this is due to adopting a pixelization of $N_{\mathrm{side}}$. The
...
$N_{\mathrm{side}}=1024$ would result in a huge number of missing
