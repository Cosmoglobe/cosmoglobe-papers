...
physical origin of the excess signal is secondary importance, and we
choose to remain agnostic in this respect. What is essential, though,
is to minimize its impact on the final ZSMA maps, which serve as the
inputs the any DIRBE-based cosmological and astrophysical analysis. 
