...
\textit{(HKE: MATHEW NEEDS TO UPDATE THIS) The sixth component correspond to \textbf{bright} starlight emission, which
is relevant in the frequency range between 1 and 25\,$\mu$m; for full
details regarding this model, see \citet{CG02_04}. For \textbf{this component}, we first
...
\textit{The AllWISE catalog itself contains a total of about 747 million
...
is also sensitive to zodiacal light and Galactic residuals. In particular, DIRBE was designed to have negligible straylight contamination, while internal thermal sources in FIRAS were explicitly measured by onboard thermistorse and subtracted before mapmaking.
%For
