...
The analysis consisted of five Gibbs chains, each of which contained
...
anticorrelated with the 100 $\mu$m hot dust amplitude. It seems reasonable
enough
the morphologies of hot dust and nearby dust are similar enough that whenever the
one increases, the other can decrease to compensate for the change. The same
