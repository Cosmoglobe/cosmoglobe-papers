...
similar four-component thermal dust model, given by the first four terms
...
the nearby dust template. This template, used in both \citet{CG02_05} and \citet{CG02_06}, was derived
from the \citet{edenhofer:2024} extinction maps (see \citealt{CG02_05} for
more details on how this template was constructed).
...
\subsection{Dust Templates}
From our companion work detailed in \citet{CG02_06}, we obtain high resolution dust template maps for the hot and cold dust components, as well as a nearby dust template and an H alpha correlated dust template. \textbf{MG:this subsection should be expanded on but I have to go now}
