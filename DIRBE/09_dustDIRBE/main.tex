...
In the current paper, we address this issue by fitting the
multi-component model proposed by \citet{CG02_05} and \citet{CG02_06}
to the re-processed \COBE-DIRBE data within the \Cosmoglobe\ DR2
analysis framework. This model consists of four primary components,
corresponding 
