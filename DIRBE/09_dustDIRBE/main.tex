...
result to all \Planck\ HFI data using an extensive search of the full parameter space. We showed
...
from the \citet{edenhofer:2024} extinction maps (see \citetalt{CG02_05} for
...
\nside=512 pixelation, giving an approximate resolution of 42\arcm. Following
