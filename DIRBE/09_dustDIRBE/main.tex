...
\begin{figure*}[t]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/new_all_fgs_bands.png}
...
The \Cosmoglobe\ DR2 production analysis resultedd in five Gibbs
...
estimate the reduction of the RMS of the residuals with respect to the
original map in \cref{fig:efficiency}.
...
signal variance is explaineed by the dust model. This can partially be
