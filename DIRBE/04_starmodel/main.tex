...
Figure \ref{fig:corr} shows the correlation matrix for a sample of star parameters. We see correlations between the monopoles of the 01, 02 and 03 bands, and anti correlations between some of the zodiacal light parameters, as discussed in \citep{CG02_01, CG02_02}. We also see correlation between the amplitude and spectral index of the second randomly selected extragalactic source, which is likely due to weak constraining power on this particular source. We do not see much cross correlation between the star parameters and other parameters in the global chain, which implies that the star parameters are well mixed and are not highly degenerate with other full sky parameters in the chains.
