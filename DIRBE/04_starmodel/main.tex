...
\begin{figure}
  ...
  \caption{Schematic diagram of the \Cosmoglobe\ DR2 compact object processing pipeline. Red ovals represent input data, and the blue boxes indicate the two classes of sources described in this paper. {\bf TODO: update bottom left image with final amplitude figure, update final number of sources to 424829, 710825587.}}
  \label{fig:diagram}
\end{figure}
...
The main operational goal of this paper is to fit the amplitude of both individual bright stars and the overall diffuse background jointly as part of the global Bayesian \Cosmoglobe\ DR2 analysis framework. The details of this process are discussed by \citet{CG02_01, CG02_02, CG02_07}, and here we only give a brief review of the main points that are directly relevant for starlight modelling.
