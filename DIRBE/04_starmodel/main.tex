...
\begin{figure*}
  ...
  \caption{Zoom-ins on a subregion of the sky centred at $(20^\mathrm{o},70^\mathrm{o})$. The third column shows the (data - model) difference between the two, and the final column is the overall chisq of the component separation fit.}
  \label{fig:zooms}
\end{figure*}
