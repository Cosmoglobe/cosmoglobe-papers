...
an angular resolution of $3^{\circ}$ FWHM to suppress instrumental noise.
...
\tablenote {{\rm f}} Uncertainty due to the hot dust zero-level, estimated to be $1\,\mu\mathrm{K}_{\mathrm{RJ}}$ at 545\,GHz.\par %
...
\bibliography{Planck_bib,CG_bibliography}
