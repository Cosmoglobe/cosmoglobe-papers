...
\noalign{\vskip 3pt} 
\omit\sc $\lambda$ ($\mu\mathrm{m}$)\hfil& U_{B_\nu\rightarrow\nu I_\nu}^{(\mathrm{a})} &\sigma_b^{\mathrm{(b)}} & \sigma_g^{\mathrm{(c)}} & \sigma_\mathrm{MC}^{\mathrm{(d)}} & \sigma_\mathrm{HM}^{\mathrm{(e)}}  & \sigma^{\mathrm{(f)}}_\mathrm{iso}  & \sigma_\mathrm{Total}^{\mathrm{(g)}}  & \mathrm{DIRBE}^{\mathrm{(h)}} & \mathrm{Gibbs}^{(\mathrm{i})} & \mathrm{Final\,DR2}^{(\mathrm{j})} & f_{\mathrm{sky}}^{(\mathrm{k})} (\%) \cr
\noalign{\vskip 3pt\hrule\vskip 5pt}
*1.25 & 2400 & 0.05 & 1.0 & 1.9  & 4.0   & 4.2 & 6.2     & <75        & 34\pm10     & *16\pm6      & 21 \cr
*2.2  & 1364 & 0.03 & 0.3 & 0.8  & 0.3   & 1.9 & 2.1     & <39        & 10.8\pm1.7  & **3.8\pm2.1  & 20 \cr
*3.5  & *857 & 0.02 & 0.3 & 0.3  & 0.5   & 2.0 & 2.1     & <23        & *8.0\pm2.2  & **8.0\pm2.1  & 24 \cr
100   & **30 & 0.81 & 1.0 & 0.4  & 0.1   & 1.2 & 2.5 & <34            & *8.8\pm1.8  & **7.1\pm2.5  & *8 \cr
140   & **21 & 5!** & 1.1 & 0.2  & 0.8   & 1.8 & 5.5 & 25.0\pm6.9     & *8\pm6      & *15\pm6      & 22 \cr
240   & **12 & 2!** & 0.7 & 0.1  & 0.2   & 0.4 & 2.2 & 13.6\pm2.5     & *6.1\pm2.3  & **4.4\pm2.2  & 26 \cr
...
\tablenote {{\rm f}} Systematic monopole uncertainty due to spatial variations, evaluated as the HMHD rms maps in Fig.~\ref{fig:hmhd} at $N_{\mathrm{side}}=4$.\par
