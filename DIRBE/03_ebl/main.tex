...
Sect.~\ref{sec:anisotropies} we cross-correlate the DIRBE CIB residual
...
12$\,\mu\mathrm{m}$ channel and less than 0.2\,MJy/sr
12$\,\mu\mathrm{m}$. Such a rapidly changing monopole spectrum is
...
Fig.~\ref{fig:sidelobes}. The current results are derived with the
...
\cosmoglobe\ posterior mean values listed in column (g).\par
...
Table~\ref{tab:EBL_monopoles}, it appears in retrospect that both
