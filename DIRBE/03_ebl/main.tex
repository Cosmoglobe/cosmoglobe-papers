...
elongations.
  ...
  \includegraphics[width=0.42\linewidth]{figs/dirbe_05_hmhs_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_06_hmhs_v4.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_07_hmhs_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_08_hmhs_v4.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_09_hmhs_v4_3deg.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_10_hmhs_v4_3deg.pdf}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.42\linewidth]{figs/dirbe_01_hmhd_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_02_hmhd_v4.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_03_hmhd_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_04_hmhd_v4.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_05_hmhd_v4.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_06_hmhd_v4.pdf}\\
...
should be the largest factor, and the fact that it does not yet do so
for several channels indicates that the DIRBE data still have
additional constraining power that can be released through further
analysis.
