...
In Sect.~\ref{sec:data}, we summarize the \cosmoglobe\ DR2 data processing and products products that are used in this analysis, before presenting updated CIB monopole constraints in Sect.~\ref{sec:mono}. We conclude in Sect.~\ref{sec:conclusions}, where we also discuss both potential future improvements and the impact of external data.
