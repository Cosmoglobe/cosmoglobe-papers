...
\begin{figure*}
  ...
  \includegraphics[width=0.38\linewidth]{figs/CGDR2_09_hmhs_fullres.pdf}\hspace*{5mm}
  \includegraphics[width=0.38\linewidth]{figs/CGDR2_10_hmhs_fullres.pdf}
  \caption{Half-mission half-sum maps, $(\m_{\mathrm{HM1}}+\m_{\mathrm{HM2}})/2$ for each DIRBE frequency channel, zoomed in around the North Ecliptic Pole. Grey pixels indicate the conservative masks used for estimating the monopole. The graticule is centered on the NEP, and the spacing is $5^{\circ}$. } 
  \label{fig:hmhs_zoom}
\end{figure*}
...
\begin{figure*}
  ...
  \includegraphics[width=0.38\linewidth]{figs/CGDR2_09_hmhd_fullres.pdf}\hspace*{5mm}
  \includegraphics[width=0.38\linewidth]{figs/CGDR2_10_hmhd_fullres.pdf}
  \caption{Half-mission half-difference maps, $(\m_{\mathrm{HM1}}-\m_{\mathrm{HM2}})/2$ for each DIRBE frequency channel, zoomed in around the North Ecliptic Pole. Grey pixels indicate the conservative masks used for estimating the monopole. The graticule is centered on the NEP, and the grid spacing is $5^{\circ}$. }
  \label{fig:hmhd_zoom}
\end{figure*}
...
\begin{figure*}
  ...
  %\includegraphics[width=0.23\linewidth]{figs/dirbe_04_hmhs_v1_zoom.pdf}\hspace*{5mm}
  %\includegraphics[width=0.23\linewidth]{figs/dirbe_04_hmhs_v1_zoom.pdf}
  \caption{Zoom-ins centered on Galactic coordinates $(l,b)=(70^{\circ},75^{\circ})$ of the inverse noise weighted full-mission (\emph{left}) and half-mission half-difference (\emph{right}) maps at $3.5\,\mu\mathrm{m}$. The graticule is centered on the NEP, and the grid spacing is $5^{\circ}$. }
