...
470k\,CPU-hrs. The first 15~samples are removed as burn-in from each
...
data prior to mapmaking. Given the complex structures in the sidelboes, it does not appear satisfactory simply to exclude
