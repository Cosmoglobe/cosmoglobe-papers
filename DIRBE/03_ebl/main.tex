...
\textbf{Updates:} Zodi oversubtraction is no longer upper limits in the same way as before. Bands 4--7 (check). Bands 4--7 should basically be removed in the monopole overview paper. The table will also be simplified.
...
500\,CPU-hrs or 4~wall-hours when run on a 128-core cluster node. In
total, we have produced 930 samples for the current analysis,
parallelized over six chains, for a total computational cost of
470k\,CPU-hrs. The first 20~samples are removed as burn-in from each
chain \citep{CG02_02}, leaving a total of 810~samples for scientific
...
elongations.
  ...
  \begin{figure*}
  \centering
  \includegraphics[width=0.42\linewidth]{figs/dirbe_01_hmhs_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_02_hmhs_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_03_hmhs_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_04_hmhs_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_05_hmhs_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_06_hmhs_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_07_hmhs_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_08_hmhs_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_09_hmhs_v5_3deg.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_10_hmhs_v5_3deg.pdf}
...
\begin{figure*}
  \centering
  \includegraphics[width=0.42\linewidth]{figs/dirbe_01_hmhd_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_02_hmhd_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_03_hmhd_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_04_hmhd_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_05_hmhd_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_06_hmhd_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_07_hmhd_v5.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_08_hmhd_v5.pdf}\\
  \includegraphics[width=0.42\linewidth]{figs/dirbe_09_hmhd_v5_3deg.pdf}\hspace*{5mm}
  \includegraphics[width=0.42\linewidth]{figs/dirbe_10_hmhd_v5_3deg.pdf}
...
for this is simplicity of interpretation. Whether the excess signal is
...
final CIB constraints translate into strict upper limits. This is
...
plausible at a purely visual level. However, the bottom case will
yield a CIB monopole that is lower by
0.8\,$\mathrm{MJy\,sr^{-1}}$. The reason for considering precisely
this value here is elaborated on in
Sect.~\ref{sec:results}. Conversely, it is not possible to add a
...
with a series of different smoothing kernels. The uncertainties
...
static component and the cloud parameters to be fitted entirely
...
determine its lowest possible zero-level. This results in the template
seen in the top panel of Fig.~\ref{fig:sidelobe} for the 25$\,\mu$m
channel. In the final production analysis, this component is then kept
fixed; for full discussion about this procedure, see \citet{CG02_01}.

As illustrated in Fig.~\ref{fig:sidelobe}, this template is a high
...
60$\,\mu\mathrm{m}$, for which this correction is applied, are
strictly upper limits.
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figs/traceplot_DR2_CIBmono_v5.pdf}
...
conservative analysis masks applied. Similar zoom-ins of around the South Ecliptic Pole are shown in Figs.~\ref{fig:hmhs_zoom_south} and \ref{fig:hmhd_zoom_south}. Again, when comparing the HMHS
...
component shown in Fig.~\ref{fig:sidelobe}. The current results are
...
Fig.~\ref{fig:hmhs_zoom} would vanish entirely.
...
\noalign{\doubleline}
\omit&&\multispan5\hfil\sc Monopole uncertainty\hfil&\multispan3\hfil\sc CIB monopole constraint \hfil\cr
\noalign{\vskip -3pt}
\omit& &\multispan5\hrulefill&\multispan3\hrulefill\cr
\noalign{\vskip 3pt} 
\omit\sc $\lambda$ ($\mu\mathrm{m}$)\hfil& U_{B_\nu\rightarrow\nu I_\nu}^{(\mathrm{a})} &\sigma_b^{\mathrm{(b)}} & \sigma_g^{\mathrm{(c)}} & \sigma_\mathrm{MC}^{\mathrm{(d)}} & \sigma_\mathrm{HM}^{\mathrm{(e)}}  & \sigma_\mathrm{Total}^{\mathrm{(f)}}  & \mathrm{DIRBE}^{\mathrm{(g)}} & \mathrm{Gibbs}^{(\mathrm{h})} & \mathrm{Final\,DR2}^{(\mathrm{i})} & f_{\mathrm{sky}}^{(\mathrm{j})} (\%) \cr
\noalign{\vskip 3pt\hrule\vskip 5pt}
*1.25 & 2400 & 0.05 & 0.5 & 1.9  & 4.2 & 4.6     & <75        & 11.7\pm5.1     & *16\pm5      & 21 \cr
*2.2  & 1364 & 0.03 & 0.1 & 0.8  & 1.9 & 2.1     & <39        & *1.9\pm1.1  & **3.8\pm2.1  & 20 \cr
*3.5  & *857 & 0.02 & 0.3 & 0.3  & 2.0 & 2.0     & <23        & *6.9\pm0.6  & **8.0\pm2.0  & 24 \cr
100   & **30 & 0.81 & 1.0 & 0.4  & 1.2 & 1.8     & <34        & 11.0\pm1.6  & **7.1\pm1.8  & *8 \cr
140   & **21 & 5!** & 1.6 & 0.2  & 1.8 & 5.6 & 25.0\pm6.9     & 17.5\pm5.5      & *15\pm6      & 22 \cr
240   & **12 & 2!** & 0.5 & 0.1  & 0.4 & 2.1 & 13.6\pm2.5     & *4.3\pm2.1  & **4.4\pm2.2  & 26 \cr
...
\tablenote {{\rm f}} Total monopole uncertainty obtained by adding the individual uncertainties in columns (b)--(f) in quadrature.\par
\tablenote {{\rm g}} Official DIRBE monopole constraints reproduced from Table~1 of \citet{hauser1998}.\par
...
\tablenote {{\rm i}} \cosmoglobe\ DR2 CIB constraint as derived with the tuned monopole masks discussed in Sect.~\ref{sec:masks}.\par
\tablenote {{\rm j}} Sky fraction used for estimating the final posterior mean monopole with the masks defined in Sect.~\ref{sec:masks}.\par
\par
\end{table*}
...
240$\,\mu\mathrm{m}$, while for the remaining channels we provide only
upper limits.
...
quadrature. The first contribution is simply the posterior RMS as
...
variations. Second, we include a contribution defined by the absolute
value of the monopole of the HMHD map. This measures modeling errors
...
errors that leads to different signatures in the first and second half
of the DIRBE survey. Third, we include a term that describes residual
...
uncertainty to this value as described by \citet{CG02_01}. Fourth, the
...
quadrature. For channels without a positive detection, we define the
upper 95\,\% confidence limit as the sum of the posterior mean value
and two times the total uncertainty.
...
constraints by \citet{hauser1998} are shown as orange markers, eight
...
3.5$\,\mu$m and at 100$\,\mu$m, while for the four channels spanning
4.9 and 60$\,\mu\mathrm{m}$ our limits are generally a factor of two
to eight times stronger than the previous results. We also note that
for the 140 and 240$\,\mu\mathrm{m}$ channels, where
\citet{hauser1998} did report positive detections, our values lower by
64\,\% and 56\,\% than the official DIRBE results, respectively. We
interpret this as being due to better zodiacal light modeling in
\cosmoglobe\ DR2, and conclude that the original estimates were biased
high by 2--$3\,\sigma$.
