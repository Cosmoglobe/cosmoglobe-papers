...
% This is not super valid since the cii analysis is standalone
...
also show typical residuals from a sample in the end of the chain (sample 700) in Figs. \ref{fig:firas_1904_res} and \ref{fig:firas_1890_res}.
