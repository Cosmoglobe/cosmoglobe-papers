...
and zodiacal
light emission \citep[e.g.,][]{K98,planck2013-pip88,2016AJ....151...71K,CG02_02,obrien2025}.%
...
\citet{CG02_01}. For these, no additional
...
templates used in this analysis, the \COBE-FIRAS \CII\ map has the lowest native resolution. We therefore convolve all involved
maps (except \CII) with the \COBE-FIRAS beam, shown in \cref{fig:firasbeam} (taking
into account the drift along Ecliptic meridians; e.g., \citealp{odegard:2019}), and repixelating to a common HEALPix
resolution of \nside=16.
...
formation as a key cooling agent, and it has long been
...
source. We have spent significant time trying alternative models
...
\cref{fig:tempfract}, which shows the relative fraction of each
...
\label{sec:residuals}
In
\cref{fig:tempfit_map_vs_res1,fig:tempfit_map_vs_res3},
...
spectral parameters to HFI data, \cite{CG02_06} finds a best-fit MBB
...
fact, above 3000\,GHz this component totally dominates the overall
...
detection of tensor-to-scalar ratio $r$). In particular, a key goal of future CMB $B$-mode
