...
ones, Edenhofer et al. (REFERENCE) was able to reconstruct such dust structures
...
\label{sec:mbb}
In Fig. \ref{fig:Bnu_comparison}, we fit the following modified blackbody model
...
line) also seems to exhibit a high intrinsic temperature, consistent with the
picture of CII tracing dust in regions of high activity.
...
( I WILL FINISH THIS WHEN THE NEW FIGURE IS IN PLACE)
