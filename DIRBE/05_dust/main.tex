...
noise contribution, $\n_i$. We assume that all data are provided as as
...
instrumental noise is totally negligible compared to calibration and
modelling uncertainties, and we therefore set $\N$ equal to a constant
in the following. Equation~\ref{eq:lss_full} therefore simplifies to 
\begin{equation}
...
removing masked the relevant pixels in $\t$ and
