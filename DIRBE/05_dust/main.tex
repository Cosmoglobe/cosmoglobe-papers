...
The fit template amplitudes per frequency band are shown in Fig.
\ref{fig:tempamp}. As is evident, the spectra of all templates show a
...
\label{sec:residuals}
In Figs. \ref{fig:tempfit_map_vs_res1}-\ref{fig:tempfit_map_vs_res3}, we show a
...
in Fig. \ref{fig:temprms} we construct a measure of the amount of signal that
