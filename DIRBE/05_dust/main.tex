...
nearby dust structures based on GAIA observations. Some of these templates are
only expected to be relevant at lower frequencies; the details of this is
described below, and summarized in table \ref{tab:bands}.
