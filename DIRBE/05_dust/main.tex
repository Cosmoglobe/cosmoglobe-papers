...
The point of all this is to say that Gibbs sampling allows us to treat a highly
interconnected problem (i.e. sampling from the joint posterior of all
parameters involved in our data model) as a 
