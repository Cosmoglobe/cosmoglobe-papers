...
We attribute our improved ZL model fit to the fact that the model parameter are sampled within a Bayesian framework. The Gibbs sampling algorithm and its implementation in Commander3 is described in detail in \cite{CG02_01}, but in short, Gibbs sampling allows us to draw samples iteratively from various conditional
distributions rather than trying to draw directly from a large and complicated
joint distribution. The following Gibbs-chain show each parameter sampled in the DR2 analysis
in correct order
\begin{alignat}{11}
\mathrm{G} &\,\leftarrow P(\mathrm{G}&\,\mid &\,\dv,&\, &\,\phantom{\mathrm{G}} &\,\xi_n, &
\,\beta_{\mathrm{sky}}& \,\a_{\mathrm{sky}}, &\,\zeta_{\mathrm{z}},
&\,\a_{\mathrm{static}})\label{eq:gibbs_G}\\
\xi_{\mathrm{n}} &\,\leftarrow P(\xi_{\mathrm{n}}&\,\mid &\,\dv,&\, &\,\mathrm{G}, &\,\phantom{\xi_n} &
\,\beta_{\mathrm{sky}}& \,\a_{\mathrm{sky}}, &\,\zeta_{\mathrm{z}},
&\,\a_{\mathrm{static}})\\
\beta_{\mathrm{sky}} &\,\leftarrow P(\beta_{\mathrm{sky}}&\,\mid &\,\dv,&\, &\,\mathrm{G}, &\,\xi_n, &
\,\phantom{\beta_{\mathrm{sky}}}& \,\a_{\mathrm{sky}}, &\,\zeta_{\mathrm{z}}, &\,\a_{\mathrm{static}})\\
\a_{\mathrm{sky}} &\,\leftarrow P(\a_{\mathrm{sky}}&\,\mid &\,\dv,&\, &\,\mathrm{G}, &\,\xi_n, &
\,\beta_{\mathrm{sky}},& \,\phantom{\a_{\mathrm{sky}},}
&\,\zeta_{\mathrm{z}}, &\,\a_{\mathrm{static}})\\
\zeta_{\mathrm{z}} &\,\leftarrow P(\zeta_{\mathrm{z}}&\,\mid &\,\dv,&\, &\,\mathrm{G}, &\,\xi_n, &
\,\beta_{\mathrm{sky}},& \,\a_{\mathrm{sky}},
&\,\phantom{\zeta_{\mathrm{z}},} &\,\a_{\mathrm{static}})\label{eq:gibbs_zodi}\\
\a_{\mathrm{static}} &\,\leftarrow P(\a_{\mathrm{static}}&\,\mid &\,\dv,&\, &\,\mathrm{G}, &\,\xi_n, &
\,\beta_{\mathrm{sky}},& \,\a_{\mathrm{sky}}, &\,\zeta_{\mathrm{z}} &\,\phantom{\a_{\mathrm{static}}})\label{eq:gibbs_static}.
\end{alignat}
The ZL parameters, sampled in~\eqref{eq:gibbs_zodi}, happen right after the sampling of galactic sky components, in an iterative process, making it much easier to decouple between the two.
...
to simulate a stochastic draw \textcolor{red}{(Or was it before sending it into powell to simulate annealing?)}. 
\begin{figure*}
    \centering
...
\begin{figure*}
    ...
    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_01.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_01.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_01.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_01.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_01.pdf}%
    }\\


    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_02.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_02.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_02.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_02.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_02.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_03.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_03.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_03.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_03.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_03.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_04.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_04.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_04.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_04.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_04.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_05.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_05.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_05.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_05.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_05.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_06.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_06.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_06.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_06.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_06.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_07.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_07.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_07.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_07.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_07.pdf}%
    }\\
...
\begin{figure*}
    \centering
    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_08.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_08.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_08.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_08.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_08.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_09.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_09.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_09.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_09.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_09.pdf}%
    }\\

    \resizebox{\textwidth}{!}{%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_ma_10.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_tot_10.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/cosmoglobe_zsma_10.pdf}%
    \includegraphics[height=1cm]{figs/zodi_sub/dirbe_zsma_10.pdf}%
    \includegraphics[width=1cm,angle=90]{figs/zodi_sub/cbar_10.pdf}%
    }\\
...
\section{Zodiacal light parameter atlas}
...
\clearpage
\section{Zodiacal component maps and number density}
