...
scattering contribution at 4.9 $\mu$m. The ZL SED is composed of two 
blackbody like spectra with a minimum around the $3.5\mu$m band. The first
...
Markov Chains for N samples. Our best-fit parameters for the geometrical IPD parameters
and emissivity and albedo parameters are listed in tables~\ref{table:zodi-params-geo} 
and~\ref{table:zodi-params-spectral}, where they are compared to the K98 parameters.
