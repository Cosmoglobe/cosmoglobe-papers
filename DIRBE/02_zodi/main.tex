...
instance, in the 1.25\,$\mu$m first half-mission map, denoted by "a", which corresponding to the first five
...
In the 1.25\,$\mu$m half-mission "a" map, we also see a sharp edge $45^{\circ}$
south-west of the Galactic center, and that edge corresponds to the
beginning of the DIRBE observing period. Similarly, in the half-mission "b" map, we
...
larger region of missing pixels is seen in half-mission "b".
