...
1.25\,$\mu$m TOD when estimating the 4.9\,$\mu$m \textbf{emissivity. In practice,
...
solar-centric coordinates, just like the circumsolar ring described
...
in \textbf{a preliminary analysis run} for a 12+25\,$\mu$m ZL sampling
