...
noise, $\n=\dv-\s_{\mathrm{tot}}$, is Gaussian, \textbf{distributed with 
zer mean and a covariance matrix $\N_{\mathrm{w}}$ that also has free parameters. 
For most instruments that is an excellent approximation.} In that case, we can
