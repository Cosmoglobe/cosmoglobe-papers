...
\begin{figure*}
  ...
  \begin{table*}
    \caption{Best fit zodiacal light parameters from this analysis and the K98 model.}
    \label{table:zodi parameters}
    \begin{tabularx}{\textwidth}{l l r r}
        \hline \hline
        Parameter\hspace{10mm} & Description \hspace{30mm} & \hspace{5mm} This work \hspace{5mm} & \hspace{5mm}K98\hspace{5mm} \\
        \hline
        \multicolumn{4}{c}{Smooth Cloud}\\
        \hline
        $n_0$ [AU$^{-1}$] & Density at 1 AU & $1.13 \times 10^{-7} \pm 6.4 \times 10^{-10}$ & $1.13 \times 10^{-7} \pm 6.4 \times 10^{-10}$ \\
        $\alpha$ & Radial power-law exponent & $1.34 \pm 0.022$ & $1.34 \pm 0.022$ \\
        $\beta$ & Vertical shape parameter & $4.14 \pm 0.067$ & $4.14 \pm 0.067$ \\
        $\gamma$ & Vertical power-law exponent &  $0.942 \pm 0.025$ & $0.942 \pm 0.025$ \\
        $\mu$ & Widening parameter &  $0.189 \pm 0.014$ & $0.189 \pm 0.014$ \\
        $i$ [deg] & Inclination & $2.03 \pm 0.017$ & $2.03 \pm 0.017$ \\
        $\Omega$ [deg] & Ascending node & $77.7 \pm 0.6$ & $77.7 \pm 0.6$ \\
        $X_0$ [AU] & x offset from Sun & $0.0119 \pm 0.0011$ & $0.0119 \pm 0.0011$ \\
        $Y_0$ [AU] & y offset from Sun & $0.00548 \pm 0.00077$ & $0.00548 \pm 0.00077$ \\
        $Z_0$ [AU] & z offset from Sun & $-0.00215 \pm 0.00043$ & $-0.00215 \pm 0.00043$ \\
        \hline
        \multicolumn{4}{c}{Dust Band 1}\\
        \hline
        $n_{B1}$ [AU$^{-1}$] & Density at 3 AU & $5.59 \times 10^{-10} \pm 7.20 \times 10^{-11}$ & $5.59 \times 10^{-10} \pm 7.20 \times 10^{-11}$ \\
        $\delta_{\zeta_{B 1}}$ [deg] & Shape parameter & $8.78 \phantom{\pm 0.00} \mathrm{Fixed}$ & $8.78 \phantom{\pm 0.00} \mathrm{Fixed}$ \\
        $v_{B 1}$  & Shape parameter & $0.10 \phantom{\pm 0.00} \mathrm{Fixed}$ & $0.10 \phantom{\pm 0.00} \mathrm{Fixed}$ \\
        $p_{B 1}$  & Shape parameter & $4 \phantom{\pm 0.00} \mathrm{Fixed}$ & $4 \phantom{\pm 0.00} \mathrm{Fixed}$ \\
        $i_{B 1}$ [deg] & Inclination & $0.56 \phantom{\pm 0.00} \mathrm{Fixed}$ & $0.56 \phantom{\pm 0.00} \mathrm{Fixed}$ \\
        $\Omega_{B 1}$ [deg] & Ascending node &  $80 \phantom{\pm 0.00} \mathrm{Fixed}$ & $80 \phantom{\pm 0.00} \mathrm{Fixed}$ \\
        $\delta_{R_{B 1}}$ [AU] & Inner radial cutoff & $1.5 \phantom{\pm 0.00} \mathrm{Fixed}$ & $1.5 \phantom{\pm 0.00} \mathrm{Fixed}$ \\
        \hline
        \multicolumn{4}{c}{Dust Band 2}\\
        \hline
        $n_{B2}$ [AU$^{-1}$] & Density at 3 AU & $1.99 \times 10^{- 9} \pm 1.28 \times 10^{-10}$ & $1.99 \times 10^{- 9} \pm 1.28 \times 10^{-10}$ \\
        $\delta_{\zeta_{B 2}}$ [deg] & Shape parameter &  $1.99  \phantom{\pm 0.00}$ Fixed & $1.99  \phantom{\pm 0.00}$ Fixed \\
        $v_{B2}$  & Shape parameter & $0.90  \phantom{\pm 0.00}$ Fixed & $0.90  \phantom{\pm 0.00}$ Fixed \\
        $p_{B2}$  & Shape parameter & $4 \phantom{\pm 0.00}$ Fixed  & $4 \phantom{\pm 0.00}$ Fixed \\
        $i_{B2}$ [deg] & Inclination &  $1.2 \phantom{\pm 0.00}$ Fixed & $1.2 \phantom{\pm 0.00} $Fixed \\
        $\Omega_{B2}$ [deg] & Ascending node &   $30.3 \phantom{\pm 0.00}$ Fixed & $30.3 \phantom{\pm 0.00}$ Fixed \\
        $\delta_{R_{B2}}$ [AU] & Inner radial cutoff & $0.94 \phantom{\pm 0.00}$ Fixed & $0.94 \phantom{\pm 0.00}$ Fixed \\
        \hline
        \multicolumn{4}{c}{Dust Band 3}\\
        \hline
        $n_{B3}$ [AU$^{-1}$] & Density at 3 AU & $ 1.44 \times 10^{-10} \pm 7.20 \times 10^{-11}$ & $ 1.44 \times 10^{-10} \pm 7.20 \times 10^{-11}$ \\
        $\delta_{\zeta_{B 3}}$ [deg] & Shape parameter &  $15 \phantom{\pm 0.00}$ Fixed & $15 \phantom{\pm 0.00}$ Fixed \\
        $v_{B3}$  & Shape parameter & $0.05 \phantom{\pm 0.00}$ Fixed & $0.05 \phantom{\pm 0.00}$ Fixed \\
        $p_{B3}$  & Shape parameter & $4 \phantom{\pm 0.00}$ Fixed & $4 \phantom{\pm 0.00}$ Fixed \\
        $i_{B3}$ [deg] & Inclination & $0.8 \phantom{\pm 0.00}$ Fixed & $0.8 \phantom{\pm 0.00}$ Fixed \\
        $\Omega_{B3}$ [deg] & Ascending node &  $80 \phantom{\pm 0.00}$ Fixed & $80 \phantom{\pm 0.00}$ Fixed \\
        $\delta_{R_{B3}}$ [AU] & Inner radial cutoff & $1.5 \phantom{\pm 0.00}$ Fixed & $1.5 \phantom{\pm 0.00}$ Fixed \\
        \hline
        \multicolumn{4}{c}{Circumsolar Ring}\\
        \hline
        $n_\mathrm{SR}$ [AU$^{-1}$] & Density at 1 AU & $ 1.83 \times 10^{-8} \pm 1.27 \times 10^{-9}$ & $ 1.83 \times 10^{-8} \pm 1.27 \times 10^{-9}$ \\
        $R_\mathrm{SR}$ [AU] & Radius of peak density &  $1.03 \phantom{\pm 0.00}  0.00016$ & $1.03 \phantom{\pm 0.00}  0.00016$\\
        $\sigma_\mathrm{rSR}$ [AU]  & Radial dispersion & $0.025 \phantom{\pm 0.00}$ Fixed &  $0.025 \phantom{\pm 0.00}$ Fixed \\
        $\sigma_\mathrm{zSR}$ [AU]  & Vertical dispersion & $0.054 \phantom{\pm 0.00} 0.0066$ & $0.054 \phantom{\pm 0.00} 0.0066$ \\
        $i_\mathrm{RB}$ [deg] & Inclination & $0.49 \phantom{\pm 0.00} 0.063$ & $0.49 \phantom{\pm 0.00} 0.063$ \\
        $\Omega_\mathrm{RB}$ [deg] & Ascending node &$ 22.3 \phantom{\pm 0.00} 0.0014$ & $22.3 \phantom{\pm 0.00} 0.0014$ \\
        \hline
        \multicolumn{4}{c}{Trailing Feature}\\
        \hline
        $n_\mathrm{TB}$ [AU$^{-1}$] & Density at 1 AU & $ 1.9 \times 10^{-8} \pm 1.27 \times 10^{-9}$ & $ 1.9 \times 10^{-8} \pm 1.27 \times 10^{-9}$  \\
        $R_\mathrm{TB}$ [AU] & Radius of peak density &  $1.06 \pm 0.011$ & $1.06 \pm 0.011$ \\
        $\sigma_\mathrm{rTB}$ [AU]  & Radial dispersion &  $0.10 \pm 0.0097$ & $0.10 \pm 0.0097 $\\
        $\sigma_\mathrm{zTB}$ [AU]  & Vertical dispersion & $0.091 \pm  0.013$ & $0.091 \pm  0.013$\\
        $\theta_\mathrm{TB}$ [deg] & Longitude with respect to Earth & $-10 \phantom{\pm 0.00}$ Fixed & -10 $\phantom{\pm 0.00}$ Fixed \\
        $\sigma_\mathrm{\theta TB}$ [deg] & Longitude dispersion &  $12.1 \pm 3.4$ & $12.1 \phantom{\pm 0.00} 3.4$ \\
        \hline
    \end{tabularx}
\end{table*}
