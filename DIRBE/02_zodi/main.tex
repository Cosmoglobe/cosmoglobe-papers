...
free parameter. Figure~\ref{fig:band1} shows one specific (and
...
\citet{CG02_01}. \textbf{Details regarding the foreground model are provided
by \citet{CG02_04,CG02_05,CG02_06,CG02_07}}.
...
\begin{figure}[t]
    ...
    single pre-production Gibbs chain, showning the burn-in phase. Each discrete jump indicates the 
...
\begin{figure*}[h!]
    ...
    \caption{\textbf{Trace plots of all geometrical and shape IPD parameters, along with the power-law exponent of the IPD
     temperature, the phase function parameters, and the full-sky averaged ZL intensity traces for six selected DIRBE channels. 
...
\begin{figure}[h!]
    ...
    follows the definition of Equation~\ref{eq:phase_function} and uses all the post-burn-in parameters 
...
Figure~\ref{fig:phase_function} shows the phase function $\Phi(\Theta)$ as defined 
