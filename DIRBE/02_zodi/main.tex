...
law index which is expected to be $\sim 0.5$ for grey dust. In addition to emitting thermally, IPD grains also scatter
...
parameters in Fig.~\ref{fig:trace-emissivity-albedo}.
...
%   on other results.}  
The gray regions indicate the discarded burn-in.
