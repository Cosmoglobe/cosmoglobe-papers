...
\begin{figure}
    ...
    \caption{Subsample of the pre-processed TOD used in this analysis for all ten DIRBE bands. The timestreams
...
Quadrilateral cube projection. As part of the data proprocessing, we
convert these to corresponding HEALPix pixel indicies and re-order
...
\begin{figure*}
    \centering
    \includegraphics[width=1\textwidth]{figs/zodi_correlations.png}
...
quantiative behaviour, with a significant drift during the first
...
$\chi^2$ after intialization, and then explore a very small region
...
wavelenghts is simply very faint, and therefore it is also less
important.
...
model, and we start by inspecing the half-mission data-minus-model
...
consider whether this could be explained in terms of straylight
...
These qualitative observations can be made more quantatitive by
...
further discussion regarding the scientific impliciations of these
