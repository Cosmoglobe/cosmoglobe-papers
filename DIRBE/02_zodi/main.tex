...
uncertainties. For instance, \textbf{the density parameters of dust bands
1 and 2 are about 66\,\% and 21\,\% lower in the DR2 model than in K98. 
At the same time, at frequencies lower than 140\,$\mu$m the emissivities are
higher in the DR2 model than in the K98 model for all the components. This accounts for a
similar total intensity, despite the lower densities. } 
