...
\abstract{We present the first Baysian framework for global modelling of zodiacal light in the time-domain. We demonstrate the strength of this approach by reanalysing the Diffuse Infrared Background Experiment (DIRBE) time-ordered data within the \Cosmoglobe\ framework in three parts. In the first part, we fix the zodiacal light model in the analysis to the Kelsall et al. 1998 (K98) zodiacal light model and find that we are successfully reproducing the zodiacal light corrections in the official DIRBE analysis. In the second part we re-estimate the exact zodiacal light parameters fitted in the DIRBE analysis and show that we achieve better determined zero-levels and lower zodiacal light residuals through global baysian analysis. In the final part we demonstrate the potential of the framework for improving zodiacal light modelling by generalizing the K98 model and incorporating various features from the Rowan-Robinson and May 2013 (RRM) model. When integrated with archival and new data such as AKARI, IRAS and SphereX, this framework will will be detrimential part in improving zodiacal light modelling, and ultimatly help make a large part of the infrared spectrum usable for cosmology.}
