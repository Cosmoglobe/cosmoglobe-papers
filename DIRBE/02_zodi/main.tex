...
them into a time-ordered format. For full details on the preprocessing
of the DIRBE CIO we refer to \cite{CG02_01}.
...
ZL dominated channels due to the relative strength of ZL at these bands. 
