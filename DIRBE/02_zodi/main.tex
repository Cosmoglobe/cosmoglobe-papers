...
around that initial point. Because of the combination of a very low absolute ZL signal-to-noise ratio of the
...
\begin{figure}
    ...
    \caption{(\textit{Top panel}:) ZL intensity as a function of wavelength on the 01-01-2024
...
parameter is about 40\,\% lower in the DR2 model than in K98. At the 
