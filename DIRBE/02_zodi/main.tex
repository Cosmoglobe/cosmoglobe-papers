...
old K98 models for many parameters vary significantly more than predicted
...
\begin{figure*}[t]
    ...
    \caption{Half-mission split residual maps for each channel. All bands between 1.25 and 100$\,\mu$m have been smoothed with a $15\arcm$ Gaussian kernel, and the 140 and 240\,$\mu$m channels have been smoothed with a $30\arcm$ FWHM kernel. The gray regions represent unobserved pixels in the half-mission splits.}
