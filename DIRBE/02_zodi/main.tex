...
The introduction of an free non-zero albedo parameter at the 4.9 $\mu$m 
channel also means that we are fitting both an emissivity and albedo in this channel. 
The degeneracies in the two parameter become apparent by the suddenly jump in value 
simultaneously for both the emissivity and albedo traces in all but the the red chain.
In Equation \eqref{eq:los}
