...
\begin{figure}
    ...
    \caption{Excess DIRBE ZSMA rms as compared to the \cosmoglobe\ DR2 maps,
      $(\sigma_{\mathrm{DIRBE}}^2-\sigma_{\mathrm{DR2}})/\sigma_\mathrm{DR2}$,
      evaluated outside the DR2 analysis masks and given in units of percent.}
    \label{fig:zsma_rms}
\end{figure}
