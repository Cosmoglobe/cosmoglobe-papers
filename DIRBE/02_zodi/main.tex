...
\begin{figure*}[t]
    ...
    \caption{\textbf{Traceplots of all the geometrical and shape IPD parameters kept free in 
...
\begin{figure*}
    ...
    \caption{\textbf{Traceplots of the wavelength dependent emissivity and albedo parameters. 
    Different colors indicate five independent Markov chains, the gray regions indicate the burn-in set for each 
    parameter, and vertical axes were cropped to emphasize convergence.}}
...
identifies regions with a high \textbf{signal-to-noise ratio (S/N)} for ZL, 
...
\textbf{Examining the traceplots helps to evaluate the degree of convergence for individual parameters. Starting
with the shape parameters for the dominant cloud component shown in
the leftmost column in Fig.~\ref{fig:trace-ipd}, we see that many
...
\textbf{Figure~\ref{fig:phase_function} compares our new phase function, $\Phi(\Theta)$, 
...
important goal was to understand how well the current data constrain
