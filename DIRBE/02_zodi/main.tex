...
write the likelihood, $\mathcal{L}(\omega) \equiv P(\dv|\omega)$, as \textbf{\textit{check this!!!}}
\textbf{
\begin{align}
...
\textbf{\textit{Here something about this additional logN should be said!!}}
...
convert these to corresponding HEALPix \footnote{\url{http://healpix.sourceforge.net/}} \citep{healpix} pixel indices and re-order
...
%Something to say about the Mean zodi column?
