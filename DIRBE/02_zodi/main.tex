...
\begin{figure*}
    ...
    \caption{\textbf{Trace plots of all geometrical and shape IPD parameters, along with the power-law exponent of the IPD
     ...
     Different colors indicate two independent Markov chains, and the gray regions indicate burn-in.}}
    \label{fig:trace-ipd}
\end{figure*}
...
produced a total of \textbf{1251} full Gibbs samples, distributed over \textbf{two}
Markov chains. We remove the first \textbf{100} samples from each chain as
burn-in, leaving a total of \textbf{1051} samples for final analysis. In total,
\textbf{256} computing cores were used to produce this sample set, for a
total cost of about \textbf{96k} CPU-hrs.
...
quantitative behavior, with a slight drift during the first
\textbf{100}~samples, and generally long correlation lengths. 
For the \textbf{60--240}\,$\mu$m channels the correlation lengths are extremely
...
is highly structured, reflecting the structure of the 
complex ZL likelihood. 
...
post-burn-in samples. \textbf{The resulting values for the shape parameters
