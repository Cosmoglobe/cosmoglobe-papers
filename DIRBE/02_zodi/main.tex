...
% write an abstract 
   ...
   using the combination of DIRBE Calibrated Individual Observations (CIO), \Planck\ HFI 
   ...
   wavelengths. \textbf{At high Galactic latitudes the total rms of each DR2 map is lower than the corresponding 
...
in \commanderthree\ support for \textbf{the K98 model combined with the scattering phase function described 
...
models that are derived in the post-burn-in phase appear visually
...
but after that, they look more stationary. We also
...
\begin{figure*}[h!]
    ...
    selection. \textit{(Middle column):} DIRBE ZSMA maps. \textit{(Right column):} Our ZL subtracted mission-average 
