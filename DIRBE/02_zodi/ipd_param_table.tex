...
\begin{table*}
    ...
    \multicolumn{9}{c}{Interplanetary dust parameters}\\
    \hline
    \hline
     Parameter & Description & \multicolumn{3}{c}{DIRBE} & \multicolumn{3}{c}{DR2} & Uniform prior\\ 
     \hline
...
\begin{table*}
    ...
    \newcolumntype{C}{ @{}>{${}}r<{{}$}@{} }
    \begin{tabular}{l l *2{rCl}c}
    \multicolumn{9}{c}{Source function parameters}\\
    \hline
    \hline
    Parameter & Description & \multicolumn{3}{c}{DIRBE} & \multicolumn{3}{c}{DR2} & Uniform prior\\ 
    \hline
