...
\begin{document} 
   ...
   \title{\bfseries{\Cosmoglobe\ DR2. VI. HFI commander fit dust templates}}
...
\subsection{Nearby Dust and Dust extinction}
\label{sec:otherdata}
...
\subsection{Extinction dust (\texorpdfstring{\ion{H}{$\alpha$}}{Ha} correlated dust)}
\label{sec:halpha}
