...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figures/chisq.pdf}\\
    \includegraphics[width=\linewidth]{figures/chisq.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.84\linewidth]{figures/comp_cmb.pdf}\\
    \includegraphics[width=0.84\linewidth]{figures/comp_ff.pdf}\\
    \includegraphics[width=0.84\linewidth]{figures/comp_co10.pdf}\\
    \includegraphics[width=0.84\linewidth]{figures/comp_co21.pdf}\\
    \includegraphics[width=0.84\linewidth]{figures/comp_co32.pdf}
...
\begin{figure*}
    ...
    \caption{Hot dust (\ion{C}{II} correlated dust) amplitudes for varying $T_\mathrm{H\alpha}$ and $\beta_\mathrm{H\alpha}$ values with all other grid parameters set to the fiducial values as recorded in \cref{tab:SEDs}. The center panel is the fiducial map. The corresponding cold dust maps can be seen in \cref{fig:hot_cold_dust_set}. This explores only $a_\mathrm{H\alpha}=1$.}
...
\begin{figure*}
    ...
    \caption{Cold dust (\ion{H}{I} correlated dust) amplitudes for varying $T_\mathrm{H\alpha}$ and $\beta_\mathrm{H\alpha}$ values with all other grid parameters set to the fiducial values as recorded in \cref{tab:SEDs}. The central panel is the fiducial map. The corresponding hot dust maps can be seen in \cref{fig:Ha_hot_dust_set}. This explores only $a_\mathrm{H\alpha}=1$.}
