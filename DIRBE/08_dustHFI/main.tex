...
\begin{figure}[t]
    ...
    \caption{\RS{UPDATE THIS} Efficiency of the dust model. Along the y-axis we plot result from the input map minus the non-dust components (e.g. CMB, free-free, CO) squared minus the residuals squared, divided by the map squared. This informs how much of the signal is represented by the model, and we find that it is greater than 99\% across all HFI bands.
	}
