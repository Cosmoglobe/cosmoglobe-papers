...
\begin{figure}[t]
    ...
    \includegraphics[width=0.97\linewidth]{figures/BothHotColdCorr_v2.pdf}
...
\centering
\hspace*{1.5cm}\includegraphics[width=0.8\textwidth]{figures/coldDust_cold_Grid_ratio_v4.pdf}
