...
one MBB dust component was fitted to the \Planck\ data, but allowing
for spatial variations of $T$ and $\beta$. The \Planck\ 2015 maps are
...
map space analysis.}.  While $\beta$ is relatively flat on the sky, we
see that $T$ varies significantly. In this analysis
\citep{planck2014-a12}, CIB was not fitted separately, and the CIB
...
\citet{planck2016-XLVIII} fitted separate CIB and thermal dust
components to the \Planck\ data using GNILC, a needlet ILC code with
power spectrum priors. Also here the thermal dust component was
modelled as a 1-component MBB with variable $T$ and $\beta$ as plotted
...
map is varying more on the sky.

In the bottom of \cref{fig:beta_T} we have used \Commander1 to fit a
1-component MBB with varing spectral indices to the 4-component dust
...
very similar as a 1-component model with a close to constant $\beta$
and a varying temperature $T$. Except for at high latitudes, where the
...
agree very well. This shows that the effective 1-component MBB from
\Planck\ 2015 can instead be replaced with the new simpler 4-component
