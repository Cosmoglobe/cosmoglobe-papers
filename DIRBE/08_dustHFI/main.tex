...
\begin{figure*}[t]
    \centering
\includegraphics[width=0.7\linewidth]{figures/dustComp_coldDust.pdf}
\includegraphics[width=0.7\linewidth]{figures/dustComp_hotDust.pdf}
\includegraphics[width=0.4\linewidth]{figures/dustComp_Himap_sb.pdf}
\includegraphics[width=0.4\linewidth]{figures/dustComp_firasCII_sb.pdf}
