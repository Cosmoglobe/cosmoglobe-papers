...
\begin{figure}
    ...
    \caption{Cold dust grid search with colour representing the $\chi^2$. In this case we ideally the lowest $\chi^2$, however points in the red-gridded area (ADD RED GRID AND MAKE POINTS CONTOURS, ADD SPECIFIC POITNS THAT WILL BE PLOTTED) show unphysical characteristics (such negative large scale values).}
