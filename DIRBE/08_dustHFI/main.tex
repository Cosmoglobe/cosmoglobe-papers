...
\begin{figure*}
    \centering
    \includegraphics[width=\linewidth]{figures/AvgDust_Grid_smcbar.pdf}
...
\begin{figure}
    ...
    \caption{Efficiency of the model representing the data. Taking the input map squared minus the residuals, divided by the residuals and summed across the map we can measure how much of the signal is represented by the model and find that it is greater than 90\% across all HFI bands. There is one point for each band, though many are overlapping.}
