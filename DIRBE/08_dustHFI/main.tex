...
\KG{I dont think the other papers have TOCs}
\tableofcontents
...
Additionally, we use the Wisconsin H-$\alpha$ mapper data as a template for the \Ha\ correlated dust, and the results from \citep{CG02_05} as the fiducial values for the \Ha\ MBB, since we find \KG{that} it is poorly constrained by the \planck\ bands (see \cref{sec:results}). As with DIRBE, the \Ha\ dust is a small extinction component in the \Planck\ bands.  
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/dust_corr_sm_part1.pdf}\\
    \includegraphics[width=\linewidth]{figures/dust_corr_sm_part2.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/correlation_plot_nodame.pdf}
