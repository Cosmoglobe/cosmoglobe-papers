...
Mapmaking for traditional cosmological experiments has been studied in depth for decades, with a variety of methods available to optimally solve the mapmaking equation under different assumptions \citep{tegmark1997, natoli2001, keihanen2005, stompor2008, patanchon2008}. However, most of these methods are designed for experiments that take data in the form of time-ordered data (TOD), i.e., a one-dimensional stream of data taken as the instrument scans the sky. In this work, we focus on spectroscopy-based experiments, experiments that record two-dimensional data: frequency and position dependent. In particular, we will simulate and test our mapmaking algorithms in Fourier-transform spectrometers (FTS), but this method is easily generalized to any spectroscopy-based experiments with this kind of two-dimensional data, especially as the Fourier transform that is needed specific to the FTS is used as a post-processing step.
%  Examples of such experiments include Fourier-transform spectrometers (FTS) such as FIRAS \citep{fixsen:1994,mather:1999}, PIXIE \citep{kogut2011}, and LiteBIRD \citep{litebird2022}, as well as other types of spectrometers such as DESHIMA \citep{endoh2016} and SuperSpec \citep{shirokoff2012}.
