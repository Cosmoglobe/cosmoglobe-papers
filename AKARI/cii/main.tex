...
\begin{document} 
   ...
   \title{\bfseries{\Cosmoglobe\ DR3. XII AKARI Galactic [CII] line emission map}}

   \input{../common/authors_cii.tex}
   ...
   \abstract{
    We present a new high-resolution estimate of the Galactic 158\micron [CII] line emission using AKARI WIDE-L and N60 data. 
    This work is part of the third Cosmoglobe data release (DR3), re-analyzing the data of the AKARI infrared satellite covering wavelengths $40$--$200$\micron using the global Bayesian end-to-end Gibbs sampling framework \commander3. At $120$--$200\micron$ the main contributions to the signal measured by the AKARI WIDE-L and N160 bands are from thermal dust, which can be diveded into a cold, hot and nearby component, as well as the line emission from singly-ionized carbon at 158\micron. The 158\micron [CII] emission can be estimated by subtracting a bandpass-integrated estimate of the thermal dust emission from the AKARI data. In particular, as the hot dust component and the [CII] emission will trace similar high-energy environments, 
   }
