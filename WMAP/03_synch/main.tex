...
Although most of the results in \citet{watts2023_dr1} use the posterior mean of the Gibbs chain, here we perform our analysis on each of the  500 frequency map samples individually. This allows us to fully marginalize over the low-level systematic parameters, quantifying the amount instrumental processing propogates to the synchrotron spectral index determination.
