...
%We find good agreement with the EE/BB ratio reported in \Planck\ 2018 using their half-mission results. For the \Planck\ data, we use standard deviation of the single-$\ell$ spectrum values within each bin, while we add the systematic quadrature from the \cosmoglobe\ chain in quadrature. Compare with, e.g., \citet{planck2014-a12}'s Figure 44.
