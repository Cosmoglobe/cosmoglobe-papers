...
In the following, we add the resulting differences in quadrature to the uncertainty due to statistical and systematic errors to account for prior ignorance. 
