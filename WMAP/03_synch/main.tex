...
\begin{figure*}
	...
	\end{center}
	\caption{Differences between \cosmoglobe\ DR1 synchrotron model evaluated at $5^\circ$, with common colorscale of $\pm\,5\,\mathrm{\mu K}$. \cosmoglobe\ maps are labeled CG, \Planck\ 2018 and \npipe\ maps are labeled PR3 and PR4, and the legacy \WMAPnine\ maps are labeled \WMAP.}
