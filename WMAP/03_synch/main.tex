...
We plot the total polarized amplitude $P=\sqrt{Q^2+U^2}$ for ease of comparison. The visible noise bias from plotting this positive definite quantity

, although it creates a visible noise bias in the low signal-to-noise regions. 
