...
As stated in \citet{bp14} (Svalheim), we use scale-dependent priors in component separation so that the prior will play a negligible role in signal-dominated regions, but play a stronger role in noise-dominated regions.
