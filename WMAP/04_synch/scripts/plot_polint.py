...
for mcmc in ['c']:
    ...
    plt.savefig('../figures/polint_WMAP9.png', bbox_inches='tight')
...
plt.savefig('../figures/polint_PR3.png', bbox_inches='tight')
...
plt.savefig('../figures/polint_PR4.png', bbox_inches='tight')
...
plt.savefig('../figures/polint_BP.png', bbox_inches='tight')
...
plt.savefig('../figures/polint_CG.png', bbox_inches='tight')
