...
# Load data
wmap2 = np.loadtxt('lnL_BB_wmap-1.txt')
wmap3 = np.loadtxt('lnL_BB_wmap-2.txt')
wmap4 = np.loadtxt('lnL_BB_wmap-3.txt')
wmap5 = np.loadtxt('lnL_BB_wmap-4.txt')
wmap6 = np.loadtxt('lnL_BB_wmap-5.txt')
wmap7 = np.loadtxt('lnL_BB_wmap-6.txt')
wmap8 = np.loadtxt('lnL_BB_wmap-7.txt')
wmap9 = np.loadtxt('lnL_BB_wmap-8.txt')
wmap10 = np.loadtxt('lnL_BB_wmap-9.txt')

reprod2 = np.loadtxt('lnL_BB_reprod-1.txt')
reprod3 = np.loadtxt('lnL_BB_reprod-2.txt')
reprod4 = np.loadtxt('lnL_BB_reprod-3.txt')
reprod5 = np.loadtxt('lnL_BB_reprod-4.txt')
reprod6 = np.loadtxt('lnL_BB_reprod-5.txt')
reprod7 = np.loadtxt('lnL_BB_reprod-6.txt')
reprod8 = np.loadtxt('lnL_BB_reprod-7.txt')
reprod9 = np.loadtxt('lnL_BB_reprod-8.txt')
reprod10 = np.loadtxt('lnL_BB_reprod-9.txt')


tempcorr2 = np.loadtxt('lnL_BB_tempcorr-1.txt')
tempcorr3 = np.loadtxt('lnL_BB_tempcorr-2.txt')
tempcorr4 = np.loadtxt('lnL_BB_tempcorr-3.txt')
tempcorr5 = np.loadtxt('lnL_BB_tempcorr-4.txt')
tempcorr6 = np.loadtxt('lnL_BB_tempcorr-5.txt')
tempcorr7 = np.loadtxt('lnL_BB_tempcorr-6.txt')
tempcorr8 = np.loadtxt('lnL_BB_tempcorr-7.txt')
tempcorr9 = np.loadtxt('lnL_BB_tempcorr-8.txt')
tempcorr10 = np.loadtxt('lnL_BB_tempcorr-9.txt')
...
plt.xlabel(r"Power spectrum, $D_{\ell}^{BB}$ [$\mu\mathrm{K}^2$]");
ax7.yaxis.labelpad = 10*width/17.; ax7.xaxis.labelpad = 10*width/17. # distance of axis label to tick labels
...
plt.savefig("lnL_BB_v1.pdf", bbox_inches='tight', bbox_extra_artists=[],pad_inches=0.03)
