...
# Load data
dataK = np.loadtxt('alpha_CG_023-WMAP_K_v1.dat')
dataKa = np.loadtxt('alpha_CG_030-WMAP_Ka_v1.dat')
dataQ1 = np.loadtxt('alpha_CG_040-WMAP_Q1_v1.dat')
dataQ2 = np.loadtxt('alpha_CG_040-WMAP_Q2_v1.dat')
dataV1 = np.loadtxt('alpha_CG_060-WMAP_V1_v1.dat')
dataV2 = np.loadtxt('alpha_CG_060-WMAP_V2_v1.dat')
dataW1 = np.loadtxt('alpha_CG_090-WMAP_W1_v1.dat')
dataW2 = np.loadtxt('alpha_CG_090-WMAP_W2_v1.dat')
dataW3 = np.loadtxt('alpha_CG_090-WMAP_W3_v1.dat')
dataW4 = np.loadtxt('alpha_CG_090-WMAP_W4_v1.dat')
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"K123", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"K124", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Ka123", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Ka124", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Q123", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Q124", fontsize=10)
plt.ylim([-1.6, -0.4]);
plt.yticks([-1.4,-1.0,-0.6], [r"$-1.4$", r"$-1.0$", r"$-0.6$"])
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Q211", fontsize=10)
plt.ylabel(r"$\alpha$");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Q212", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Q223", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"Q224", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"V123", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"V124", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"V211", fontsize=10)
plt.ylabel(r"$\alpha$");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"V212", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"V223", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"V224", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W123", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W124", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W211", fontsize=10)
plt.ylabel(r"$\alpha$");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W212", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W223", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W224", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W311", fontsize=10)
plt.ylabel(r"$\alpha$");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W312", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W323", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W324", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W411", fontsize=10)
plt.ylabel(r"$\alpha$");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W412", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W423", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(52200,-0.6,r"W424", fontsize=10)
plt.ylim([-1.6, -0.4]);
...
plt.savefig("instpar_CG_alpha_v1.pdf", bbox_inches='tight', bbox_extra_artists=[],pad_inches=0.03)
