...
mjd_wmap = np.arange(1,3280+1)/3280.*1069
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.25,r"K123", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.25,r"K124", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.16,r"Ka123", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.16,r"Ka124", fontsize=10)

###############
#   Q1-band
###############

mjd_wmap = np.arange(1,3280+1)/3280.*1330
wmap2 = wmap[8,:]
inds = (np.abs(wmap2) < 0.1)
for i in range(len(inds)):
    if inds[i]:
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.06,r"Q123", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.06,r"Q124", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.10,r"Q213", fontsize=10)
plt.ylabel(r"Gain [du/mK]");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.10,r"Q214", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.10,r"Q223", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,1.10,r"Q224", fontsize=10)
...
mjd_wmap = np.arange(1,3280+1)/3280.*897
wmap2 = wmap[16,:]
inds = (np.abs(wmap2) < 0.1)
for i in range(len(inds)):
    if inds[i]:
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.55,r"V123", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.55,r"V124", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.46,r"V213", fontsize=10)
plt.ylabel(r"Gain [du/mK]");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.46,r"V214", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.46,r"V223", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.46,r"V224", fontsize=10)
...
mjd_wmap = np.arange(1,3280+1)/3280.*1346
wmap2 = wmap[24,:]
inds = (np.abs(wmap2) < 0.1)
for i in range(len(inds)):
    if inds[i]:
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.31,r"W123", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.31,r"W124", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.305,r"W213", fontsize=10)
plt.ylabel(r"Gain [du/mK]");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.305,r"W214", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.305,r"W223", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.305,r"W224", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.282,r"W313", fontsize=10)
plt.ylabel(r"Gain [du/mK]");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.282,r"W314", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.282,r"W323", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.282,r"W324", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.286,r"W413", fontsize=10)
plt.ylabel(r"Gain [du/mK]");
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.286,r"W414", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.24,r"W423", fontsize=10)
...
plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
plt.text(30,0.24,r"W424", fontsize=10)
