...
plot_text_coords = [[52200, 11.2]] * 40  # all channels
...
for i in range(40):
    ...
    axs.append(currax)
    channel = ind2chan[i]
    samples1 = chain1.get(f'tod/{channel}/chisq')
    samples2 = chain2.get(f'tod/{channel}/chisq')
...
plt.savefig("../../figures/instpar_CG_chisq_v1.pdf", bbox_inches='tight',
