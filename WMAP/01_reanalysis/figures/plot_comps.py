...
cg.plot(f'{DIR}/CG_cmb_IQU_n1024_v1.fits', comp='cmb', min=-3400, max=3400,
    ...
    llabel='T')
plt.savefig('cmb_I_dipole.pdf', bbox_inches='tight', dpi=100)
...
plt.savefig('synch_I.pdf', bbox_inches='tight', dpi=100)
...
plt.savefig('synch_Q.pdf', bbox_inches='tight', dpi=100)
...
plt.savefig('synch_U.pdf', bbox_inches='tight', dpi=100)
...
plt.savefig('synch_Q_std.pdf', bbox_inches='tight', dpi=100)
...
plt.savefig('dust_I.pdf', bbox_inches='tight', dpi=100)

cg.plot(f'{DIR}/CG_dust_IQU_n1024_v1.fits', comp='dust', min=-5, max=5,
    norm='linear', width=4,llabel='Q',sig=1,
    rlabel=r'\langle A_\mathrm{d}\rangle')
plt.savefig('dust_Q.pdf', bbox_inches='tight', dpi=100)
cg.plot(f'{DIR}/CG_dust_IQU_n1024_v1.fits', comp='dust', min=-5, max=5,
    norm='linear', width=4,llabel='U',sig=2,
    rlabel=r'\langle A_\mathrm{d}\rangle')
plt.savefig('dust_U.pdf', bbox_inches='tight', dpi=100)
