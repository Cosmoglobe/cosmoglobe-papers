...
cg.plot(f'{DIR}/CG_cmb_IQU_n1024_v1.fits', comp='cmb', 
    ...
    rlabel=r'\langle A_\mathrm{cmb}\rangle')
plt.savefig('cmb_Q.pdf', bbox_inches='tight', dpi=300)
cg.plot(f'{DIR}/CG_cmb_IQU_n1024_v1.fits', comp='cmb', 
    width=4, sig=2, fwhm=np.sqrt(1-(14/60)**2)*u.deg,
    min=-10, max=10, xsize=1600,
    rlabel=r'\langle A_\mathrm{cmb}\rangle')
plt.savefig('cmb_U.pdf', bbox_inches='tight', dpi=300)
...
plt.savefig('synch_I.pdf', bbox_inches='tight', dpi=300)
...
plt.savefig('synch_Q.pdf', bbox_inches='tight', dpi=300)
...
plt.savefig('dust_I.pdf', bbox_inches='tight', dpi=300)

cg.plot(f'{DIR}/CG_dust_IQU_n1024_v1.fits', comp='dust', min=-5, max=5,
    norm='linear', width=4,llabel='Q',sig=1,
    rlabel=r'\langle A_\mathrm{d}\rangle')
plt.savefig('dust_Q.pdf', bbox_inches='tight', dpi=300)
cg.plot(f'{DIR}/CG_dust_IQU_n1024_v1.fits', comp='dust', min=-5, max=5,
    norm='linear', width=4,llabel='U',sig=2,
    rlabel=r'\langle A_\mathrm{d}\rangle')
plt.savefig('dust_U.pdf', bbox_inches='tight', dpi=300)
