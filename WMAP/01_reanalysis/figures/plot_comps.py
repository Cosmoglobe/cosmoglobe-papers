...
plt.savefig('cmb_I_sigma.pdf', bbox_inches='tight', dpi=dpi)
cg.plot(f'{DIR}/CG_cmb_IQU_n1024_v1.fits', sig=4, min=0, max=30,
    cmap='binary_r', unit=r'\mathrm{\mu K_{CMB}}', llabel='Q',
    rlabel=r'\sigma_\mathrm{cmb}', width=4, extend='both')
plt.savefig('cmb_Q_sigma.pdf', bbox_inches='tight', dpi=dpi)
...
plt.savefig('dust_I.pdf', bbox_inches='tight', dpi=dpi)

cg.plot(f'{DIR}/CG_dust_IQU_n1024_v1.fits', comp='dust', min=-5, max=5,
    norm='linear', width=4,llabel='Q',sig=1,
    rlabel=r'\langle A_\mathrm{d}\rangle')
plt.savefig('dust_Q.pdf', bbox_inches='tight', dpi=dpi)
cg.plot(f'{DIR}/CG_dust_IQU_n1024_v1.fits', comp='dust', min=-5, max=5,
    norm='linear', width=4,llabel='U',sig=2,
    rlabel=r'\langle A_\mathrm{d}\rangle')
plt.savefig('dust_U.pdf', bbox_inches='tight', dpi=dpi)
