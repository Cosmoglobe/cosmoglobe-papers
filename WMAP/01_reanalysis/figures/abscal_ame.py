...
plt.savefig('ame_g01.178.pdf', bbox_inches='tight')
...
plt.savefig('ame_g01.181.pdf', bbox_inches='tight')
cg.plot(f'{DIR}/chains_grid_g0_1.185/ame_c0001_k000005.fits', min=-1e2, max=1e2, 
    cmap='coolwarm', llabel='g_0=1.185', cbar=False, width=4)
plt.savefig('ame_g01.185.pdf', bbox_inches='tight')

cg.standalone_colorbar("coolwarm", ticks=[-100,0,100], extend='both',
    unit=r'$\mathrm{\mu K}$ @ 22\,GHz')
plt.savefig('cbar_100uK.pdf', bbox_inches='tight')
