...
plt.savefig('ame_g01_175.pdf', bbox_inches='tight', dpi=300)
...
plt.savefig('ame_g01_181.pdf', bbox_inches='tight', dpi=300)
...
plt.savefig('ame_g01_187.pdf', bbox_inches='tight', dpi=300)
