...
\begin{figure}
	...
	\caption{Fractional difference maps between the sum of AME and free-free emission at 22\,GHz between the \cosmoglobe\ and \bp\ foreground modes, i.e., $\Delta A_{\mathrm{K}}=s^{\mathrm{CG}}_{\mathrm{AME}+\mathrm{ff}}-s^{\mathrm{BP}}_{\mathrm{AME}+\mathrm{ff}})/s^{\mathrm{BP}}_{\mathrm{AME}+\mathrm{ff}}$.}
