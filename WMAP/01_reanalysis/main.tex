...
Although the CMB power spectrum appear to agree exceedingly well with a \LCDM\ model, several anomalies, especially at low multipoles, have been reported that  to be in tension with \LCDM. As a rule, the existence of these anomalies is not debated, but rather their significance within \LCDM. Indeed, as argued by \citet{bennett2010}, the existence of these anomalies may simply be described by the look-elsewhere effect. The relevant question is not ``How unlikely is \LCDM\ given this effect?'' but rather ``How unlikely is this effect given \LCDM?''.
