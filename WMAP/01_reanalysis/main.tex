...
\begin{figure}
	...
	\caption{Histogram of 100 000 realizations of $C_2$ given $C_2^{\Lambda \mathrm{CDM}} = 1064.7\,\mathrm{\mu K^2}$ compared with the measured power spectrum $\sigma_2$ of our universe for \Cosmoglobe\ (black) and \BP\ (blue).}
