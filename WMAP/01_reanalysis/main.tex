...
\begin{figure*}
	\centering
	\includegraphics[width=0.32\textwidth]{figures/frac_diff_ame.pdf}
	\includegraphics[width=0.32\textwidth]{figures/frac_diff_ff.pdf}
	\includegraphics[width=0.32\textwidth]{figures/frac_diff_22GHz_sum.pdf}
	\caption{Fractional difference maps, where $\Delta=$(\cosmoglobe - \BP)/\BP\ for the AME component (left), the free-free component (middle), and the AME+free-free sum evaluated at \K-band (right). Though the differences for the AME and free-free components are quite large, the sum of the components agree at the 5\,\% level within the high signal-to-noise regions of the sky.}
