...
\title{\bfseries{\Cosmoglobe\ I. Bayesian end-to-end analysis of the \emph{Wilkinson Microwave Anisotropy Probe} data}}
\input{authors.tex}
...
\section{Markov chain survey}
\label{sec:markov_chains}

\subsection{Visual inspection of trace plots and correlations}
...
\begin{figure*}
	...
	\includegraphics[width=\textwidth]{figures/030-WMAP_Ka_rms.pdf}
	\includegraphics[width=\textwidth]{figures/040-WMAP_Q1_rms.pdf}
	\includegraphics[width=\textwidth]{figures/040-WMAP_Q2_rms.pdf}
	\includegraphics[width=\textwidth]{figures/060-WMAP_V1_rms.pdf}
	\includegraphics[width=\textwidth]{figures/060-WMAP_V2_rms.pdf}
	\caption{RMS maps}
\end{figure*}
\begin{figure*}
	\centering
	\includegraphics[width=\textwidth]{figures/090-WMAP_W1_rms.pdf}
	\includegraphics[width=\textwidth]{figures/090-WMAP_W2_rms.pdf}
	\includegraphics[width=\textwidth]{figures/090-WMAP_W3_rms.pdf}
	\includegraphics[width=\textwidth]{figures/090-WMAP_W4_rms.pdf}
	\caption{RMS maps (continued)}
\end{figure*}

\begin{figure*}
	\centering
	\includegraphics[width=\textwidth]{figures/023-WMAP_K_std.pdf}
	\includegraphics[width=\textwidth]{figures/030-WMAP_Ka_std.pdf}
	\includegraphics[width=\textwidth]{figures/040-WMAP_Q1_std.pdf}
	\includegraphics[width=\textwidth]{figures/040-WMAP_Q2_std.pdf}
	\includegraphics[width=\textwidth]{figures/060-WMAP_V1_std.pdf}
	\includegraphics[width=\textwidth]{figures/060-WMAP_V2_std.pdf}
	\caption{STD maps}
\end{figure*}
\begin{figure*}
	\centering
	\includegraphics[width=\textwidth]{figures/090-WMAP_W1_std.pdf}
	\includegraphics[width=\textwidth]{figures/090-WMAP_W2_std.pdf}
	\includegraphics[width=\textwidth]{figures/090-WMAP_W3_std.pdf}
	\includegraphics[width=\textwidth]{figures/090-WMAP_W4_std.pdf}
	\caption{STD maps (continued)}
\end{figure*}
\begin{figure*}
	\centering
	\includegraphics[width=0.9\textwidth]{figures/023-WMAP_K_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/030-WMAP_Ka_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/040-WMAP_Q1_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/040-WMAP_Q2_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/060-WMAP_V1_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/060-WMAP_V2_sampdiff.pdf}
	\caption{Differences between two samples}
\end{figure*}
\begin{figure*}
	\centering
	\includegraphics[width=0.9\textwidth]{figures/090-WMAP_W1_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/090-WMAP_W2_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/090-WMAP_W3_sampdiff.pdf}
	\includegraphics[width=0.9\textwidth]{figures/090-WMAP_W4_sampdiff.pdf}
	\caption{Differences between two samples (continued)}
\end{figure*}
