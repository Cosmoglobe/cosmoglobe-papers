...
This analysis began as a pure replicability study -- could we reproduce the \WMAPnine\ analysis results using an entirely different treatment of the uncalibrated data? It was only during the \Q-band analysis by \citet{bp17} when it was determined that replicating the \WMAPnine\ results was not desirable. The maps produced by \citet{bp17} had 

This paper is the first time that the LFI polarization data have successfully reproduced an estimate of the sky as measured by the \WMAP\ data. The 
