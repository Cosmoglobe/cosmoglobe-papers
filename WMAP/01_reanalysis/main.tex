...
\begin{figure}
	...
	\caption{Histogram of 100 000 realizaitons of $C_2$ given $C_2^{\Lambda \mathrm{CDM}} = 1064.7$ compared with the measured power spectrum $\sigma_2$ of our universe for \Cosmoglobe\ (black) and \BP\ (blue).}
\end{figure}
...
\begin{figure}
	...
	\caption{The ocotpole planarity statistics $t_3$ compared with the \BP analysis (blue).}
\end{figure}
