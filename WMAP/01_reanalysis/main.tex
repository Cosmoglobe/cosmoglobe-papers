...
\begin{table*}[t]
 ...
 \halign{
    ...
    \noalign{\doubleline}
      ...
      \hskip 10pt 1\,Hz spike sampling         & 0.3& 0.4& 1.6& & & & & & & & & & &\phantom{0}2.4 \cr      
...
\begin{figure*}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/KKa_deltaQ.pdf}
	\includegraphics[width=0.45\textwidth]{figures/KKa_deltaU.pdf}
	\includegraphics[width=0.45\textwidth]{figures/Q_deltaQ.pdf}
	\includegraphics[width=0.45\textwidth]{figures/Q_deltaU.pdf}
	\includegraphics[width=0.45\textwidth]{figures/V_deltaQ.pdf}
	\includegraphics[width=0.45\textwidth]{figures/V_deltaU.pdf}
	\includegraphics[width=0.45\textwidth]{figures/W_deltaQ.pdf}
	\includegraphics[width=0.45\textwidth]{figures/W_deltaU.pdf}
	\caption{Half-difference maps, smoothed to one degree.}
\end{figure*}
