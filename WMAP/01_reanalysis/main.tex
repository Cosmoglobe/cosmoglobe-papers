...
\begin{figure}
	...
	\caption{Difference between the \cosmoglobe\ $\boldsymbol d_\mathrm{cal}=\boldsymbol d/g-\boldsymbol b - \boldsymbol s_\mathrm{sl}$ and the delivered calibrated TOD from \WMAP. \mathbf{Zoom in, maybe 0--100 seconds or less}}
...
As a final inspection of the \cosmoglobe\ map products of themselves, we 
