...
The bottom row of this figure shows the Q and U polarization maps produced from the traditional IQU mapmaker, which have been extensively verified by multiple implementations of the algorithm over many years \citep{lfi2013,lfi2015,lfi2018}. The N+2 maps look like the binned maps at the ecliptic poles, where Planck has better crosslinking, but outside of this Planck `dogbones' region they are noise and systematics dominated. This failure is clearly a problem with this method that we investigate in the next section.
